            ...
            <div class="content container-fluid">
                ...
                <?php echo form_close(); ?>
                      ...
                      ?>
                                            ...
                                            <td>
                                              <?php echo date('d F Y',strtotime($jobs->created_date)); ?>
                                                
                                            </td>
                                             <td>
                                                <?php
                                                    if($jobs->pending_status=='0')
                                                    {
                                                        echo '<span class="label label-primary">Incomplete</span>';
                                                    }

                                                    else if($jobs->pending_status=='1')
                                                    {
