                                         ...
                                         <tr>
                                            ...
                                            <td>
                                            	<?php
                                            		...
                                            		$sessionId = $this->session->userdata('auser_id');
                                            	?>
											   <a href = "<?php echo base_url('Circular/edit_circular/'.$circular->id.'/'.$sessionId) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i>Edit</a>
