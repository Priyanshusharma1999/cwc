                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						$sessionn_id = $this->session->userdata('auser_id');
     					...
     					echo form_open_multipart('Jobs/edit_jobs/'.$job_data->id.'/'.$sessionn_id,$attributes);?>
						   ...
						   <div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<!-- <div class="cal-icon"> -->
									  <input class="form-control datetimepicker" name = "start_date" autocomplete="off" id="" placeholder="dd/mm/yyyy" type="text" value = "<?php echo date('d/m/Y',strtotime($job_data->start_date));?>">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<!-- <div class="cal-icon"> -->
									  <input class="form-control datetimepicker " name = "end_date" autocomplete="off" id="" placeholder="dd/mm/yyyy" type="text" value = "<?php echo date('d/m/Y',strtotime($job_data->end_date));?>">
