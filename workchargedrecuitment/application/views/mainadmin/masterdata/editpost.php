            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
						$session_iid = $this->session->userdata('auser_id');
					 	$attributes = array('class' => '', 'id' =>'add_postt');
     					echo form_open_multipart('Superadmin/edit_post/'.$post_data->id.'/'.$session_iid,$attributes);?> 
							<div class="col-sm-6">
						  ...
						  <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Post Code" name="post_code" maxlength="50" value = "<?php echo $post_data->post_code; ?>">
