            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
						$session_userid = $this->session->userdata('auser_id');
					 	$attributes = array('class' => '', 'id' =>'add_regionn');
     					echo form_open_multipart('Superadmin/add_region/'.$session_userid,$attributes);?> 
						
						  <div class="col-sm-6">
							<div class="form-group">
								<label>Region <span class="required">*</span></label>
								<input class="form-control restrict_special_char" name="region_name" type="text" placeholder="Region " maxlength="50" value = "<?php echo isset($insertData['region_name']) ? $insertData['region_name'] : ''; ?>">
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
									...
									if($all_regions) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('d F Y', strtotime($region->created_date)); ?></td>
                                            <td>
											   <a href = "<?php echo base_url('Superadmin/edit_region/'.$region->id.'/'.$session_userid) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
											   <a  href = "<?php echo base_url('Superadmin/view_region/'.$region->id) ?>"class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
											   <button data-toggle="modal"  data-target="#deleteModal" onclick="remove_region(<?php echo $region->id ;?>)"  class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> </button>
