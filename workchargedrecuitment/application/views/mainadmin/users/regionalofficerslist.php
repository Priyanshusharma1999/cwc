                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	...
                                            	?>
											   <a href = "<?php echo base_url('Users/edit_user/'.$users->Id.'/'.$session_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
											   <a href = "<?php echo base_url('Users/view_user/'.$users->Id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
											</td>
                                        </tr>
                                        <?php } } else { ?>
