            ...
            <div class="content container-fluid">
                ...
                <hr>
                  ...
                  <?php
                                ...
                                echo form_open_multipart('Circle_applicant_admin/search_applicant/',$attributes);?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <?php $pdf_name =  $applicant_data->pdf_name;
                                                    $url ='http://katiyarprint.com/cwc-jobs/uploads/applicant_pdf/'.$pdf_name.'.pdf'; ?>
                                            <td>
                                                <a href = "<?php echo base_url('Circle_applicant_admin/view_job/'.$applicant_data->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i>View</a>
