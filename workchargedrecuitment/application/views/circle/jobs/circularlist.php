                        ...
                        <div class="card-box">
                            <div class="card-block">
								...
								<?php
		     					...
		     					echo form_open_multipart('Circle_circular/search_circular/',$attributes);?> 
								  <div class="form-group">
									<input type="text" name = "circular_title" class="form-control restrict_special_char" placeholder="Circular Title" >
								  </div>
								   <div class="form-group">
                                    ...
                                    <tbody>
										...
										<?php
                                         ...
                                         <tr>
                                            ...
                                            <td>
											   <a href = "<?php echo base_url('Circle_circular/edit_circular/'.$circular->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i>Edit</a>
											   <a href = "<?php echo base_url('Circle_circular/view_circular/'.$circular->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i>View</a>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<?php echo form_open(base_url().'Circle_circular/delete_circular'); ?>
