     					...
     					echo form_open_multipart('Superadmin/add_post/',$attributes);?> 
						  ...
						  <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Post Name" name="post_name" maxlength="80" value = "<?php echo isset($insertData['post_name']) ? $insertData['post_name'] : ''; ?>">
                            ...
                            <div class="card-block">
								...
								<form class="form-inline sr-form" action="#">
								  <div class="form-group">
								   ...
								   <div class="form-group">
									<input type="text" class="form-control" placeholder="Circle Name" >
								  </div>
								  <div class="form-group">
