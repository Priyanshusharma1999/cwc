...
class Circle extends CI_Controller {
...

	{
			...
			else
			{
					...
					$data['all_jobs'] = $this->Base_model->get_all_record_by_condition('tbl_jobs',array('circle_id'=>$circle_user_data->Circle,'status'=>'1'));
	...
	public function edit_profile()
	{
			...
			else
			{
...

				{
						  ...
						  $password  = xss_clean(strip_tags($this->input->post('passworrrrrd')));
