...
class Auth extends REST_Controller {
                  ...
                  /**********random password*****/
                        ...
                        /**Ends random pwd**/
                         ...
                         $update_data = array(
                              ...
                              'password' => hash("sha256", utf8_encode($randomString))
    ...
    public function login_post()

        {
            ...
            $device_type        = strip_tags($this->post('devicetype'));

            $device_id          = strip_tags($this->post('deviceid'));
...

        {
            ...
            $otp_enter = strip_tags($this->post('otp_enter'));
