		...
		{ 
			...
			if($this->form_validation->run() === false) 
				...
				else
				{
					...
					{
							$start_dattte = date('Y-m-d', strtotime($start_date));

					/*		$startrrr_date = str_replace('/', '-', $start_date);
							$start_dattte =date('Y-m-d', strtotime($startrrr_date));*/

							/*$date = str_replace('/', '-', $end_date);
							$end_dateeeeeee =date('Y-m-d', strtotime($date));
