                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
     					...
     					echo form_open_multipart('Superadmin/add_post/',$attributes);?> 
							<div class="col-sm-6">
						  ...
						  <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Post " name="post_name" maxlength="80" value = "<?php echo isset($insertData['post_name']) ? $insertData['post_name'] : ''; ?>">
						  ...
						  <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" type="text" placeholder="Post Code" name="post_code" maxlength="80" value = "<?php echo isset($insertData['post_code']) ? $insertData['post_code'] : ''; ?>">
                            ...
                            <div class="card-block">
								...
								<?php
								  ...
								  <div class="form-group">
								   ...
								   <div class="form-group">
									<input type="text" name = "cirrccle_nname" class="form-control" placeholder="Circle" >
								  </div>
								  <div class="form-group">
									<input type="text" name = "poosst_nname" class="form-control" placeholder="Post" >
								  </div>
                              ...
                              <table class="display datatable table table-stripped table-bordered table-responsive" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('Y-m-d', strtotime($post->created_date)); ?></td>
                                            <td>
											   <a href = "<?php echo base_url('Superadmin/edit_post/'.$post->id) ?>"class="btn btn-sm btn-info"><i class="fa fa-pencil"></i>Edit</a>
											   <a href = "<?php echo base_url('Superadmin/view_post/'.$post->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i>View</a>
											   <button data-toggle="modal"  data-target="#deleteModal" onclick="remove_post(<?php echo $post->id ;?>)"  class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Delete</button>
											</td>
                                        </tr>
                                        <?php } } else { ?>
