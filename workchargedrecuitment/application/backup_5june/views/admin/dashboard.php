                            ...
                            <div class="card-block" id = "apppllyy_job">
							  ...
							  <h3 style="text-align: center;margin-bottom: 40px;margin-top: 10px;">Apply For Job</h3>
								  ...
								  <div class="form-group">
								   ...
								   <div class="form-group">
									...
									<select id = "circle_name" name = "circle_name" required="required" class="form-control" onchange="remove_errors2('error_12')">
										<option selected="selected" value="" onchange="remove_errors2()">Select Circle</option>
								  ...
								  <div class="form-group">
									...
									<input id = "post_code" type="text" name = "post_code" class="form-control" placeholder="Post Code" required="required" onkeyup="remove_errors('error_14')" readonly />
									<span class="error_14 error"></span>
								  </div>
								
								   <div class="form-group">
									<label class="control-label">Total Vacancy<span class="required">*</span></label>
									<input id = "total_vacancy" type="text" name = "total_vacancy" class="form-control" placeholder="Total Vacancy" onkeyup="remove_errors('error_73')"  readonly />
							...
							<div class="stepwizard">
									...
									<div class="panel-body">
									   ...
									   <div class="col-sm-4">
										<div class="form-group">
											...
											<input type="text" id = "full_name" name = "full_name" required="required" value = "<?php echo isset($insertData['full_name']) ? $insertData['full_name'] : ''; ?>" class="form-control" placeholder="Enter Full Name"  readonly />
									   ...
									   <div class="col-sm-4">
										...
										<input type="text" id = "father_name" name = "father_name" required="required"  class="form-control" placeholder="Enter Father's Name" onkeyup="remove_errors('error_22')" />
									   ...
									   <div class="col-sm-4">
										<div class="form-group">
											...
											<input type="email" id = "email" name = "email" required="required" value = "<?php echo isset($insertData['email']) ? $insertData['email'] : ''; ?>" class="form-control" placeholder="Enter Email Id" readonly/>
									   ...
									   <div class="col-sm-4">
										<div class="form-group">
											...
											<input type="text" id = "mobile_no" name = "mobile_no" value = "<?php echo isset($insertData['mobile_no']) ? $insertData['mobile_no'] : ''; ?>" required="required" class="form-control"  placeholder="Enter Mobile No."  maxlength="20" readonly />
									   ...
									   <div class="col-sm-4">
											<div class="form-group">
												...
												<!-- <div class="cal-icon"> -->
												  <input name = "dob" id = "dob" class="form-control" onkeyup="remove_errors('error_25')" placeholder="dd/mm/yy" type="date" value = "<?php echo isset($insertData['dob']) ? $insertData['dob'] : ''; ?>" required="required">
								...
								<div class="panel panel-primary setup-content" id="step-2">
									  ...
									  <div class="row-ed">
									   ...
									   <div class="col-sm-2 padding-5">
											<div class="form-group">
												...
												<input type="text" id = "highschool_board_name" name = "highschool_board_name" required="required" class="form-control" placeholder="Board Name" onkeyup="remove_errors('error_27')"  />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												...
												<!-- <input type="text" id = "highschool_passing_year" name = "highschool_passing_year" required="required" class="form-control" placeholder="Year" maxlength="4" /> -->
									...
									<div class="col-sm-2 padding-5">
											<div class="form-group">
												...
												<input type="text" id = "highschool_total_marks" name = "highschool_total_marks"  class="form-control" placeholder="Total Marks" maxlength="4" onkeyup="remove_errors('error_29')" />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												...
												<input type="text" id = "highschool_marks_obtained" name = "highschool_marks_obtained"  class="form-control" placeholder="Marks Obtained" maxlength="4" onkeyup="remove_errors('error_30')" />
										...
										<div class="col-sm-1 padding-5">
											<div class="form-group">
												...
												<input type="text" id = "highschool_percentage" name = "highschool_percentage" required="required" class="form-control" placeholder="%" maxlength="5" onkeyup="remove_errors('error_31')"  />
									...
									<!--   <div class="row-ed">
										<div class="col-sm-2 nopadding">
											<div class="form-group">
												...
												<select  id ="intermediate_metriculation" name = "intermediate_metriculation" class="form-control">
									   ...
									   <div class="col-sm-3 padding-5">
											<div class="form-group">
												<input type="text" id = "intermediate_board_name" name = "intermediate_board_name" class="form-control" placeholder="Board Name" />
												<span class="error_32 error"></span>
											</div>
										</div>
										
										<div class="col-sm-1 padding-5">
											<div class="form-group">
												<select  id ="intermediate_passing_year" name = "intermediate_passing_year" required="required" class="form-control">
												   <option value="">Select Year</option>
												</select>
												<input type="text" id = "intermediate_passing_year" name = "intermediate_passing_year" class="form-control" placeholder="Year" maxlength="4" />
												<span class="error_33 error"></span>
											</div>
										</div>
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id="intermediate_total_marks" name = "intermediate_total_marks" class="form-control" placeholder="Total Marks" maxlength="4" />
												<span class="error_34 error"></span>
											</div>
										</div>
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "intermediate_marks_obtained" name = "intermediate_marks_obtained" class="form-control" placeholder="Marks Obtained" maxlength="4" />
												<span class="error_35 error"></span>
											</div>
										</div>
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "intermediate_percentage" name = "intermediate_percentage" class="form-control" placeholder="Percentage" maxlength="2" />
												<span class="error_36 error"></span>
											</div>
										</div>
									  ...
									  <div class="row-ed">
									   ...
									   <div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "graduation_qualification" name = "graduation_qualification" class="form-control" placeholder="University Name" />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<!-- <input type="text" id = "graduation_passing_year" name = "graduation_passing_year" class="form-control" placeholder="Year" maxlength="4" /> -->
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text"  id ="graduation_total_marks" name = "graduation_total_marks" class="form-control" placeholder="Total Marks" maxlength="4" />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text"  id = "graduation_marks_obtained" name = "graduation_marks_obtained" class="form-control" placeholder="Marks Obtained" maxlength="4" />
										...
										<div class="col-sm-1 padding-5">
											<div class="form-group">
												<input type="text" id = "graduation_percentage" name = "graduation_percentage" class="form-control" placeholder="%" maxlength="5" />
									  ...
									  <div class="row-ed">
									   ...
									   <div class="col-sm-2 padding-5">
											<div class="form-group">
											<input type="text" id = "post_graduation_qualification" name = "post_graduation_qualification"  class="form-control" placeholder="University Name" />
											</div>
										</div>
										
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<!-- <input type="text" id = "post_graduation_passing_year" name = "post_graduation_passing_year"  class="form-control" placeholder="Year" maxlength="4" /> -->
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text"  id = "post_graduation_total_marks" name = "post_graduation_total_marks" class="form-control" placeholder="Total Marks" maxlength="4" />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text"  id = "post_graduation_marks_obtained" name = "post_graduation_marks_obtained" class="form-control" placeholder="Marks Obtained" maxlength="4" />
										...
										<div class="col-sm-1 padding-5">
											<div class="form-group">
												<input type="text" id = "post_graduation_percentage" name = "post_graduation_percentage"  class="form-control" placeholder="%" maxlength="5" />
									  ...
									  <div class="row-ed">
									   ...
									   <div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "others_qualification" name = "others_qualification" class="form-control" placeholder="Institute Name" />
											</div>
										</div>
										
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<!-- <input type="text" id ="others_passing_year" name = "others_passing_year"  class="form-control" placeholder="Year" maxlength="4" /> -->
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "others_total_marks" name = "others_total_marks" class="form-control" placeholder="Total Marks" maxlength="4" />
										...
										<div class="col-sm-2 padding-5">
											<div class="form-group">
												<input type="text" id = "others_marks_obtained" name = "others_marks_obtained" class="form-control" placeholder="Marks Obtained" maxlength="4" />
											</div>
										...
										<div class="col-sm-1 padding-5">
											<div class="form-group">
												<input type="text" id = "others_percentage" name = "others_percentage"  class="form-control" placeholder="%" maxlength="5" />
									...
									<div class="panel-body">
									   ...
									   <div class="col-sm-4">
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<input id = "aadhar_no" name = "aadhar_no" type="text" class="form-control" placeholder="Aadhar No." maxlength="12" />
										...
										<div class="col-sm-4">
											<div class="form-group">
												<label class="control-label">Do you fulfill the eligibility of physical fitness criteria?<span class="required">*</span></label>
										...
										<div class="col-sm-4">
											<div class="form-group">
												...
												<input id = "employment_exchange" name = "employment_exchange" type="text"  class="form-control" placeholder="Registration No" />
									   ...
									   <div class="col-sm-6">
											...
											<div class="form-group">
												...
												<textarea id = "present_address" name = "present_address" class="form-control" placeholder="Present Address"></textarea>
											...
											<div class="form-group">
											   <div class="col-sm-4 padding-5">
														...
														<select id = "present_address_state" name = "present_address_state" required="required" class="form-control" onchange="remove_errors2('error_60')" >
														   ...
														   <?php
															...
															else
															{
										                      ...
										                      {   
										                         echo '<option value="'.$state->State_Code.'">'.$state->StateName_In_English.'</option>';
										                      }
															}
												...
												<div class="col-sm-4 padding-5">
													<div class="form-group">
													<input id = "present_address_pincode" type="text" name = "present_address_pincode" required="required" class="form-control" placeholder="Pin Code" maxlength="6" onkeyup="remove_errors('error_62')" />
									   	...
									   	<div class="combined-container">
											...
											<div class="form-group">
											   <div class="col-sm-4 padding-5">
												...
												<div class="col-sm-4 padding-5">
													<div class="form-group">
													<input id = "permanent_address_pincode" type="text" name = "permanent_address_pincode" required="required" class="form-control" placeholder="Pin Code" maxlength="6" onkeyup="remove_errors('error_65')" />
								...
								<div class="panel panel-primary setup-content" id="step-4">
									...
									<div class="panel-body">
									   ...
									   <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-4">
											  <label class="control-label">Upload Photo With Sign<span class="required">*</span></label>
											</div>
										    <div class="col-sm-8">
										 ...
										 <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-4">
											  <label class="control-label">Date Of Birth Certificate<span class="required">*</span></label>
											</div>
										    <div class="col-sm-8">
										 ...
										 <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-4">
											  <label class="control-label">Matriculation/ITI Marksheet<span class="required">*</span></label>
											</div>
										    <div class="col-sm-8">
										...
										<div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-4">
										    ...
										    <div class="col-sm-8">
										      <textarea class="form-control" name = "working_experience" id="working_experience" ></textarea>
										    </div>
										</div>
				   ...
				   <div class="col-lg-6">
                        <div class="card-box final-step" style="padding: 40px 40px 30px 40px;display:none;">
                            <div class="card-block">
							   <div class="form-group text-center">
									<!-- <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal" class="btn btn-warning btn-block btn-sbmt">Preview Form</a> -->

									<button  class="btn btn-warning btn-block btn-sbmt" id = "previewww_button" type="button">Final Preview Form</button>
								</div>
								 <div class="form-group text-center">
									<!-- <a href="javascript:void(0);" class="btn btn-success btn-block btn-sbmt" >Final Submit</a> -->
			...
			$('#job_apply_modaal').modal('show');
				...
				allNextBtn.click(function () {
    				...
    				if ($("#step-1").css('display') != 'none')
					{
	                    ...
	                    {
	                    	var msg = 'Please enter father name.';
				              $(".error_22").html(msg);
				              $(".error_22").show();
					...
					if ($("#step-2").css('display') != 'none')
					{
	                   ...
	                   /* if (highschool_total_marks.length === 0) 
	                    {
	                    	var msg = 'Total marks.';
				              $(".error_29").html(msg);
				              $(".error_29").show();
	                    ...
	                    /*if (highschool_marks_obtained.length === 0) 
	                    {
	                    	var msg = 'Marks Obtained.';
				              $(".error_30").html(msg);
				              $(".error_30").show();
	                    ...
	                    /*if(RE.test(highschool_percentage))
	                    {
	                    	var a = RE.test(highschool_percentage);
	                    	alert(a);
	                    }*/
	                    /*if (intermediate_board_name.length === 0) 
	                    {
	                    	var msg = 'Board name.';
				              $(".error_32").html(msg);
				              $(".error_32").show();
				              $('.error_32').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/

	                   /* if (intermediate_passing_year.length === 0) 
	                    {
	                    	var msg = 'Passing year.';
				              $(".error_33").html(msg);
				              $(".error_33").show();
				              $('.error_33').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/

	                    /*if (isNaN(intermediate_passing_year)==1) 
	                    {	alert('bnvnvn1');
    						var msg = 'Type numbers only.';
				               $(".error_33").html(msg);
				              $(".error_33").show();
	                    ...
	                    /*if (intermediate_total_marks.length === 0) 
	                    {
	                    	var msg = 'Total marks.';
				              $(".error_34").html(msg);
				              $(".error_34").show();
				              $('.error_34').css('color','red');           
	                          output = false;
	                          return output;   
	                    }
*/
	                    /*if (isNaN(intermediate_total_marks)==1) 
	                    {	alert('1nmnmnmn');
    						var msg = 'Type numbers only.';
				              $(".error_34").html(msg);
				              $(".error_34").show();
	                   ...
	                   /* if (intermediate_marks_obtained.length === 0) 
	                    {
	                    	var msg = 'Marks Obtained.';
				              $(".error_35").html(msg);
				              $(".error_35").show();
				              $('.error_35').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/

	                     /*if (isNaN(intermediate_marks_obtained)==1) 
	                    {	alert('1uuuuu');
    						var msg = 'Type numbers only.';
				              $(".error_35").html(msg);
				              $(".error_35").show();
	                    ...
	                    /*if (intermediate_percentage.length === 0) 
	                    {
	                    	var msg = 'Percentage.';
				              $(".error_36").html(msg);
				              $(".error_36").show();
				              $('.error_36').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/

	                    /*if (isNaN(intermediate_percentage)==1) 
	                    {	alert('1xcxcxcxc');
    						var msg = 'Type numbers only.';
				              $(".error_36").html(msg);
				              $(".error_36").show();
...
*/
	                    /*if (graduation_qualification.length === 0) 
	                    {
	                    	var msg = 'Board name.';
				              $(".error_37").html(msg);
				              $(".error_37").show();
				              $('.error_37').css('color','red');           
	                          output = false;
	                          return output;   
	                    }

	                    if (graduation_passing_year.length === 0) 
	                    {
	                    	var msg = 'Passing year.';
				              $(".error_38").html(msg);
				              $(".error_38").show();
	                    ...
	                    /*if (graduation_total_marks.length === 0) 
	                    {
	                    	var msg = 'Total marks.';
				              $(".error_39").html(msg);
				              $(".error_39").show();
	                    ...
	                    /*if (graduation_marks_obtained.length === 0) 
	                    {
	                    	var msg = 'Marks obtained.';
				              $(".error_40").html(msg);
				              $(".error_40").show();
	                    ...
	                    /*if (graduation_percentage.length === 0) 
	                    {
	                    	var msg = 'Percentage.';
				              $(".error_41").html(msg);
				              $(".error_41").show();
	                    ...
	                    if (isNaN(graduation_percentage)==1) 
	                    {
	                     ...
	                     /*if (isNaN(post_graduation_passing_year)==1) 
	                    {
    						var msg = 'Type numbers only.';
				              $(".error_42").html(msg);
				              $(".error_42").show();
				              $('.error_42').css('color','red');           
	                          output = false;
	                          return output;      
	                    }*/
	                    ...
	                    /* if (isNaN(others_passing_year)==1) 
	                    {
    						var msg = 'Type numbers only.';
				              $(".error_46").html(msg);
				              $(".error_46").show();
				              $('.error_46').css('color','red');           
	                          output = false;
	                          return output;      
	                    }*/
					...
					if ($("#step-3").css('display') != 'none')
					{
	                    ...
	                    {
	                    	var msg = 'Aadhar number required.';
				              $(".error_54").html(msg);
				              $(".error_54").show();
				              $('.error_54').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/
	                   ...
	                   /* if (employment_exchange.length === 0) 
	                    {
	                    	var msg = 'Employment exchange no required.';
				              $(".error_56").html(msg);
				              $(".error_56").show();
				              $('.error_56').css('color','red');           
	                          output = false;
	                          return output;   
	                    }*/
...
/*	//function for accept only numbers

	function validatenumber(el) {
	  var regex = /^[0-9]*(?:\.\d{1,2})?$/;    // allow only numbers [0-9] 
	  if( !regex.test(el.value) ) {
	      var msg = 'Please enter numbers only';
          $(".error_24").html(msg);
          $(".error_24").show();
          $('.error_24').css('color','red');               
          output = false;
    ...
    //function for remove father name
