...
class Admin extends CI_Controller {
	...
	public function index()
	{
		...
		$to_date = date('Y-m-d', strtotime('+8 months'));
		...
		$data['superadmin_pension_retired_employee'] = $this->Base_model->get_expiry_employee($from_date,$to_date,NULL);
		$data['superadmin_pension_paper_submit_status'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'Yes','DELETES'=>0));
		$data['superadmin_pension_paper_submit_status_no'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'No','DELETES'=>0));
		...
		$data['pao_admin_pension_paper_submit_status'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'Yes','DELETES'=>0));
		$data['pao_admin_pension_paper_submit_status_no'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'No','DELETES'=>0));

		//echo $session_id; exit;

	  $data['pao_admin_pension_retired_employee'] = $this->Base_model->get_expiry_employee($from_date,$to_date,$session_id);
		...
		$data['division_admin_pension_retired_employee'] = $this->Base_model->get_expiry_employee($from_date,$to_date,$session_id);
		$data['division_admin_pension_paper_submit_status'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'Yes','MODIFIEDBY_ID'=>$session_id,'DELETES'=>0));

		$data['division_admin_pension_paper_submit_status_no'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'No','MODIFIEDBY_ID'=>$session_id,'DELETES'=>0));
		...
		$data['organisation_admin_pension_retired_employee'] = $this->Base_model->get_expiry_employee($from_date,$to_date,$session_id);
 		$data['organisation_admin_pension_paper_submit_status'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'Yes','MODIFIEDBY_ID'=>$session_id,'DELETES'=>0));

 		$data['organisation_admin_pension_paper_submit_status_no'] = $this->Base_model->get_all_record_by_condition('pensrecoinfo',array('PENSION_PAPER_SUBMIT_STATUS' => 'No','MODIFIEDBY_ID'=>$session_id,'DELETES'=>0));
