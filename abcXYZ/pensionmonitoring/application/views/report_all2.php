								...
								if($check_certificate_status=='1')
								{
									$ab .= '<div id = "pp8" style="visibility:hidden;"><div class="pension-table">
											...
											<table border width="100%" id="1" style="border: 1px solid black;" >
											 ...
											 <tr><th >'.$j1['organisation_name'].' : It is certified that no pension case in respect of "<b>'.$j1['organisation_name']. '</b>" is pending either with PAO or with this organization/office as on date:'.date('d F, Y').'</th></tr>
											 <tr></tr>';
