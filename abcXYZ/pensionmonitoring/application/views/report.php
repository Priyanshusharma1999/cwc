        ...
        <div class="col-sm-9" style="width:80%;">
		   ...
		   <div id="messagemodal" class="modal fade" role="dialog">
			...
			<div id = "pp1" style="clear: both">
				...
				<div class="col-sm-9" style="margin-bottom:25px;padding-left:0;">
							<span><b>Organisation Name:</b></span> <span><?php echo '<b style="color: #f7541d;">'.$organisation_name.'</b>'; ?></span>	
				</div>
				<div class="col-sm-3 text-right" style="margin-bottom:25px;padding-right:0;">
					...
					<?php 
							...
							else if($a1>0 || $b1>0 || $c1>0 || $d1>0)
							{
								...
								if($check_certificate_status=='1')
								{
									...
									echo 'It is certified that no pension case in respect of "<b>'.$organisation_name. '</b>" is pending either with PAO or with this organization/office as on date: '.date('d F Y',strtotime($pension_certificate_data->CRATEDDATE)).'.</p>   ';
								}
...
<!--div pp3 for pdf-->
			...
			<?php
					...
					$last_updatedate = $this->Base_model->lastupdatepensionrecored($all_data_POPSEF[0]->ORGANISATION);
        	...
        	<div id = "pp3"  style="visibility:hidden;max-height:20px;overflow:hidden">
        		<div class="col-sm-12 text-right" style="margin-bottom:25px;padding-right:0;">
				 ...
				 <div class="col-sm-12" style="margin-bottom:25px;padding-left:0;">
							<span><b>Organisation Name:</b></span> <span><?php echo '<b>'.$organisation_name.'</b>'; ?></span>&nbsp;&nbsp;&nbsp;
