            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php if($this->session->flashdata('flashError_useredit')) { ?>
						<div class='alert alert-danger' > <?php echo $this->session->flashdata('flashError_useredit'); ?> 
						...
						$session_user_id = $this->session->userdata('applicant_user_id'); 
     					...
     					echo form_open_multipart('Users/edit_user/'.$uri.'/'.$session_user_id,$attributes);?>
						    ...
						    <div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" autocomplete="off" type="text" name="full_name" value="<?php echo $user_detail->FULLNAME; ?>" placeholder="Full Name">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" autocomplete="off" type="text" maxlength="10" name="mobile_no" value="<?php echo $user_detail->MOBILE; ?>" placeholder="Mobile No.">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="email" autocomplete="off" name="email" value="<?php echo $user_detail->EMAIL; ?>" placeholder="Email">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" autocomplete="off" name="user_name" value="<?php echo $user_detail->LOGONID; ?>" placeholder="User Name" readonly>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="password" id="pwd2" name="con_password" placeholder="Confirm Password" >
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select  class="form-control" name="status">
									    <option value="1" <?php if($user_detail->STATUS == '1') echo 'selected="selected"' ?>>Active</option>
										<option value="0" <?php if($user_detail->STATUS == '0') echo 'selected="selected"' ?>>Deactive</option>
									</select>
