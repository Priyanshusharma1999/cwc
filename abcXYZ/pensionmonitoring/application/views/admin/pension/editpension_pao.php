  ...
  ?>
	 <div class="page-wrapper">
			...
			<input readonly type="hidden" name="pension_type" value="<?php echo $pensioner_detail[0]->PENSION_TYPE; ?>" id="pensiontype">

			 <input type="hidden" name="hid1" value="" id="block1_adhar">
 			 <input type="hidden" name="hid2" value="" id="block1_pan">
						  ...
						  <h5 class="divider">Basic Details</h6>
						   ...
						   <div class="col-sm-6">
								<div class="form-group">
									...
									<input readonly class="form-control" type="text" name="name" value="<?php echo $pensioner_detail[0]->EMPLY_NAME; ?>" placeholder="Name of the Employee/Pensioner">
						   ...
						   <div class="col-sm-6">
								<div class="form-group">
									...
									<div class="cal-icon">
									  <input readonly class="form-control datetimepicker" autocomplete="off" id="datepicker11" name="date_ret" value="<?php if(!empty($pensioner_detail[0]->DATE_RETIREMENT)) { echo date('d/m/Y',strtotime($pensioner_detail[0]->DATE_RETIREMENT)); } ?>" placeholder="dd/mm/yy" type="text">
									</div>
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input readonly class="form-control" type="text" maxlength="10" value="<?php echo $pensioner_detail[0]->MOBILENO; ?>" name="mobile_no" placeholder="Mobile No">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input readonly class="form-control" type="text" value="<?php echo $pensioner_detail[0]->EMAILID; ?>" name="email" placeholder="Email Id">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input readonly class="form-control adhar_1_chng" type="text" name="aadhar_no" placeholder="Aadhar No." id="adhar_1" value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input readonly class="form-control pan_1_chng" id="pan_1" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>" >
					     ...
					     <div class="col-sm-6">
							...
							<!---------->
									...
									<div class="form-group">
										...
										<select readonly name="pension_paper_submit" id="" class="form-control pension_paper_submit">
										   <?php
											...
											if($pensioner_detail[0]->PENSION_PAPER_SUBMIT_STATUS == 'No')
												{?>
								...
								<div class="form-group">
									...
									<div class="cal-icon">
									<input readonly class="form-control datetimepicker" autocomplete="off" type="text" id="datepicker12" name="pension_paper_submission_date" placeholder="Pension Paper Submission Date" value = "<?php echo date('d/m/Y',strtotime($pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE)); ?>">
								</div>
							...
							<div class="col-sm-6" id="ppono">
								<div class="form-group">
									...
									<input readonly class="form-control" type="text" maxlength="12" value="<?php echo $pensioner_detail[0]->PPO_NO; ?>" name="ppo_number" placeholder="PPO No.">
					...
					<h5 class="divider">Remarks</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<textarea readonly class="form-control" name="remarks"  placeholder="Remarks"><?php echo $pensioner_detail[0]->DESCRIPTION; ?>
									</textarea>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAO Remarks<span class="required"></span></label>
									<textarea class="form-control" name="pao_remarks"  placeholder="PAO Remarks"><?php echo $pensioner_detail[0]->PAO_DESCRIPTION; ?>
									</textarea>
									<span class = "text-danger"><?php echo form_error('pao_remarks');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input class="form-control" name = "filesss" type="file" accept=".pdf,.doc,.docx">
                                    </div>
                                </div>
                            </div>
		...
		<!--**********************************************************************************************************-->
		             ...
		             <?php
						...
						$uri = $this->uri->segment('3'); 
     					...
     					echo form_open_multipart('pension/edit_pension/'.$uri.'/'.$sessionn_id,$attributes);?> 
						  ...
						  <input readonly type="hidden" name="pension_type" value="<?php echo $pensioner_detail[0]->PENSION_TYPE; ?>" id="pensiontype1">

						   <input type="hidden" name="hid1" value="" id="block2_adhar">
 			 				 <input type="hidden" name="hid2" value="" id="block2_pan">
						   ...
						   <div class="col-sm-6">
							...
							<div class="col-sm-6" id="dod">
								<div class="form-group">
									...
									<div class="cal-icon">
									 <input readonly class="form-control datetimepicker" autocomplete="off" id="datepicker13"  name="date_death" value="<?php if(!empty($pensioner_detail[0]->DATE_DEATH)){ echo date('d/m/Y',strtotime($pensioner_detail[0]->DATE_DEATH)); }?>"  placeholder="dd/mm/yy" type="text">
									</div>
							...
							<div class="col-sm-6" id="namofm">
								<div class="form-group">
									...
									<input readonly class="form-control" type="text" value="<?php if(!empty($pensioner_detail[0]->FAMILYMEM_NAME)){ echo $pensioner_detail[0]->FAMILYMEM_NAME; } ?>" name="name_familymember" placeholder="Name of Family Member">
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input readonly class="form-control adhar_2_chng" type="text" name="aadhar_no" placeholder="Aadhar No." id="adhar_2" value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input readonly id="pan_2" class="form-control pan_2_chng" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>" >
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Status Details</h6>		
							...
							<!--fffff-->
								...
								<div class="form-group">
									<label>Pension Paper Submission Date<span class="required">*</span></label>
									<div class="cal-icon">
									<input readonly class="form-control datetimepicker" autocomplete="off" type="text" id="datepicker14" name="pension_paper_submission_date" placeholder="Pension Paper Submission Date" value = " <?php echo date('d/m/Y',strtotime($pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE)); ?>">
									</div>
									<span class = "text-danger"><?php echo form_error('pension_paper_submission_date');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Remarks</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAO Remarks<span class="required"></span></label>
									<textarea readonly class="form-control" name="pao_remarks"  placeholder="PAO Remarks"><?php echo $pensioner_detail[0]->PAO_DESCRIPTION; ?>
									</textarea>
									<span class = "text-danger"><?php echo form_error('pao_remarks');?></span>
								</div>
							</div>
	...
	<!--**********************************************************************************************************-->
		            ...
		            <?php
						...
						$uri = $this->uri->segment('3'); 
     					...
     					echo form_open_multipart('pension/edit_pension/'.$uri.'/'.$sessionn_id,$attributes);?> 
						  ...
						  <input readonly type="hidden" name="pension_type" value="<?php echo $pensioner_detail[0]->PENSION_TYPE; ?>" id="pensiontype2">

						  <input type="hidden" name="hid1" value="" id="block3_adhar">
 			 				<input type="hidden" name="hid2" value="" id="block3_pan">
						  ...
						  <h5 class="divider">Basic Details</h6>
						   ...
						   <div class="col-sm-6" id="dor">
								<div class="form-group">
									<label>Date of Retirement<span class="required">*</span></label>
									<div class="cal-icon">
									  <input readonly class="form-control datetimepicker" autocomplete="off" id="datepicker15" name="date_ret" value="<?php if(!empty($pensioner_detail[0]->DATE_RETIREMENT)) { echo date('d/m/Y',strtotime($pensioner_detail[0]->DATE_RETIREMENT)); } ?>" placeholder="dd/mm/yy" type="text">
									</div>
									  <span class = "text-danger"><?php echo form_error('date_ret');?></span>
								</div>
							</div>
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input readonly class="form-control adhar_3_chng" type="text" name="aadhar_no" id="adhar_3" placeholder="Aadhar No." value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input readonly class="form-control pan_3_chng" id="pan_3" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>" >
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Status Details</h6>		
							...
							<!--ddddddddd-->
								...
								<div class="form-group">
									<label>Pension Paper Submission Date<span class="required">*</span></label>
									<div class="cal-icon">
									<input readonly class="form-control datetimepicker" type="text" autocomplete="off" id="datepicker16"  name="pension_paper_submission_date" placeholder="Pension Paper Submission Date" value = "<?php echo date('d/m/Y',strtotime($pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE)); ?>">
									</div>
									<span class = "text-danger"><?php echo form_error('pension_paper_submission_date');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Remarks</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Remarks<span class="required"></span></label>
									<textarea readonly class="form-control" name="remarks"  placeholder="PAO Remarks"><?php echo $pensioner_detail[0]->DESCRIPTION; ?>
									</textarea>
									<span class = "text-danger"><?php echo form_error('pao_remarks');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAO Remarks<span class="required"></span></label>
									<textarea  class="form-control" name="pao_remarks"  placeholder="Remarks"><?php echo $pensioner_detail[0]->PAO_DESCRIPTION; ?>
									</textarea>
									<span class = "text-danger"><?php echo form_error('remarks');?></span>
								</div>
							</div>
	...
	<!--**********************************************************************************************************-->
		              ...
		              <?php
						...
						$uri = $this->uri->segment('3'); 
     					...
     					echo form_open_multipart('pension/edit_pension/'.$uri.'/'.$sessionn_id,$attributes);?> 
						  ...
						  <input readonly type="hidden" name="pension_type" value="<?php echo $pensioner_detail[0]->PENSION_TYPE; ?>" id="pensiontype3">

						  <input type="hidden" name="hid1" value="" id="block4_adhar">
 			 				<input type="hidden" name="hid2" value="" id="block4_pan">
						   ...
						   <div class="col-sm-6">
							...
							<div class="col-sm-6" id="dod">
								<div class="form-group">
									<label>Date of Death<span class="required">*</span></label>
									<div class="cal-icon">
									 <input readonly class="form-control datetimepicker" autocomplete="off" id="datepicker17" name="date_death" value="<?php if(!empty($pensioner_detail[0]->DATE_DEATH)){ echo date('d/m/Y',strtotime($pensioner_detail[0]->DATE_DEATH)); }?>"  placeholder="dd/mm/yy" type="text">
									</div>
									 <span class = "text-danger"><?php echo form_error('date_death');?></span>
								</div>
							</div>
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input readonly class="form-control adhar_4_chng" type="text" name="aadhar_no" placeholder="Aadhar No." id="adhar_4" value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input readonly class="form-control pan_4_chng" id="pan_4" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>">
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Status Details</h6>		
							...
							<!--ndhdjddjd-->
								...
								<div class="form-group">
									<label>Pension Paper Submission Date<span class="required">*</span></label>
									<div class="cal-icon">
									<input readonly class="form-control datetimepicker" autocomplete="off" type="text" id="datepicker18" name="pension_paper_submission_date" placeholder="Pension Paper Submission Date" value = "<?php echo date('d/m/Y',strtotime($pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE)); ?>  ">
									</div>
									<span class = "text-danger"><?php echo form_error('pension_paper_submission_date');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Remarks</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Remarks<span class="required"></span></label>
									<textarea readonly class="form-control" name="remarks"  placeholder="PAORemarks"><?php echo $pensioner_detail[0]->DESCRIPTION; ?>
									</textarea>
									<span class = "text-danger"><?php echo form_error('remarks');?></span>
								</div>
							</div>
     ...
     /********* ends 4 *********/
	      ...
	      var type= '<?php echo $pensioner_detail[0]->PENSION_TYPE; ?>';
		   ...
		   if (type == 'POPSEF')
			...
			//////////////
			var pension_paper_submit_status ="<?php echo $pensioner_detail[0]->PENSION_PAPER_SUBMIT_STATUS;?>"
			
			if(pension_paper_submit_status == 'Yes')
			{
				$(".submission_date").show();
				$(".submission_status2").hide();
			}

			else if(pension_paper_submit_status == 'No')
			{
