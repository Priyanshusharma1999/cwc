						  ...
						  <h5 class="divider">Basic Details</h6>
						   ...
						   <div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="name" value="<?php echo $pensioner_detail[0]->EMPLY_NAME; ?>" placeholder="Name of the Employee/Pensioner">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="emp_designation" placeholder="Employee/Pensioner Designation"  value = "<?php echo $pensioner_detail[0]->EMP_DESG; ?>">
						   ...
						   <div class="col-sm-6">
								<div class="form-group">
									<label>Date of Retirement<span class="required">*</span></label>
									  <input class="form-control" name="date_ret" value="<?php if(!empty($pensioner_detail[0]->DATE_RETIREMENT)) { echo date('Y-m-d',strtotime($pensioner_detail[0]->DATE_RETIREMENT)); } ?>" placeholder="dd-mm-yy" type="date">
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" maxlength="10" value="<?php echo $pensioner_detail[0]->MOBILENO; ?>" name="mobile_no" placeholder="Mobile No">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php echo $pensioner_detail[0]->EMAILID; ?>" name="email" placeholder="Email Id">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control adhar_1_chng " id="adhar_1" type="text" name="aadhar_no" placeholder="Aadhar No." value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control pan_1_chng" id="pan_1" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<textarea class="form-control" name="address" placeholder="Present Residential Address"><?php echo $pensioner_detail[0]->ADDRESS; ?>
									</textarea>
					...
					<h5 class="divider">Status Details</h6>	
					     ...
					     <div class="col-sm-6">
							...
							{?>
								<div class="col-sm-6">
									<div class="form-group">
										...
										<select name="pension_paper_submit" id="" class="form-control pension_paper_submit">
								...
								<div class="form-group">
									...
									<input class="form-control" type="date" name="pension_paper_submission_date" placeholder="Pension Paper Submission Date" value = "<?php echo $pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE; ?>">
							...
							<?php } else if($pensioner_detail[0]->PENSION_PAPER_SUBMIT_STATUS == 'No'){ ?>
								...
								<div class="form-group">
									<label>Pension Paper Submission Date<span class="required">*</span></label>
									<input class="form-control" type="date" name="pension_paper_submission_date" placeholder="Pension Paper Submission Dat" value = "<?php echo $pensioner_detail[0]->PENSION_PAPER_SUBMIT_DATE; ?>">
									<span class = "text-danger"><?php echo form_error('pension_paper_submission_date');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<select  name="pao_status" class="form-control">
									   <option value="">Select Status</option>
							...
							<div class="col-sm-6" id="ppono">
								<div class="form-group">
									...
									<input class="form-control" type="text" maxlength="12" value="<?php echo $pensioner_detail[0]->PPO_NO; ?>" name="ppo_number" placeholder="PPO No.">
							...
							<div class="col-sm-6" id="ppostatus">
								<div class="form-group">
									...
									<textarea class="form-control" name="status_pensioner" placeholder="status of pension papers"><?php echo $pensioner_detail[0]->STATUS_PENS_PAPER; ?>
									</textarea>
							...
							<div class="col-sm-6 nodispaly" id="withdrawal">
								<div class="form-group">
									...
									<textarea class="form-control" name="withdrawal" placeholder="NSDL"><?php echo $pensioner_detail[0]->WITHDRAWAL_REQ_NSDL; ?>
									</textarea>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<textarea class="form-control" name="specific_details"  placeholder="details"><?php echo $pensioner_detail[0]->TREMINAL_BENIFIT_GRANT; ?>
									</textarea>
		             ...
		             <?php
						   ...
						   <div class="col-sm-6">
							...
							<div class="col-sm-6" id="dod">
								<div class="form-group">
									<label>Date of Death<span class="required">*</span></label>
									 <input class="form-control"  name="date_death" value="<?php if(!empty($pensioner_detail[0]->DATE_DEATH)){ echo date('Y-m-d',strtotime($pensioner_detail[0]->DATE_DEATH)); }?>" id="datepicker" placeholder="dd-mm-yy" type="date">
							...
							<div class="col-sm-6" id="namofm">
								<div class="form-group">
									...
									<input class="form-control" type="text" value="<?php if(!empty($pensioner_detail[0]->FAMILYMEM_NAME)){ echo $pensioner_detail[0]->FAMILYMEM_NAME; } ?>" name="name_familymember" placeholder="Name of Family Member">
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input class="form-control adhar_2_chng " id="adhar_2" type="text" name="aadhar_no" placeholder="Aadhar No." value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input class="form-control pan_2_chng" id="pan_2" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>">
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
		            ...
		            <?php
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input class="form-control adhar_3_chng " type="text" name="aadhar_no" placeholder="Aadhar No." id="adhar_3" value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>" >
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input class="form-control pan_3_chng" id="pan_3" type="text" name="pan_no" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>">
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
					...
					<h5 class="divider">Status Details</h6>		
							...
							<div class="col-sm-6 nodispaly" id="statusterm">
								<div class="form-group">
									...
									<textarea class="form-control" name="terminal_ben" placeholder="status of pension papers"><?php echo $pensioner_detail[0]->STATUS_TERM_BENI_NOT_GRANT; ?>
									</textarea>
		              ...
		              <?php
						...
						<h5 class="divider">Contact Details</h6>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>Aadhar No.<span class="required"></span></label>
									<input class="form-control adhar_4_chng " id="adhar_4" type="text" name="aadhar_no" placeholder="Aadhar No." value = "<?php echo $pensioner_detail[0]->AADHAR_NO; ?>">
									<span class="aadhar_validation"></span>
									<span class = "text-danger"><?php echo form_error('aadhar_no');?></span>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label>PAN No.<span class="required">*</span></label>
									<input class="form-control pan_4_chng" type="text" name="pan_no" id="pan_4" placeholder="PAN No." value = "<?php echo $pensioner_detail[0]->PAN_NO; ?>">
									<span class = "text-danger"><?php echo form_error('pan_no');?></span>
								</div>
							</div>
