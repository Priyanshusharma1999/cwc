  ...
  /******************************************Pension POPSEF Code***************************************/
   ...
   foreach ($all_data_POPSEF as $popsef_data)
    {
	   ...
	   //$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PAN_NO.','.$pension_contact_data->AADHAR_NO;
	    $email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
   		...
   		$pension_popsef[''] = empty($popsef_data->PENSION_STATUS) ? '':$popsef_data->PENSION_STATUS;
		   ...
		   foreach ($all_data_POPSOF as $popsof_data)
		    {
				...
				$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
		   		...
		   		$pension_popsof[''] = empty($popsof_data->PENSION_STATUS) ? '':$popsof_data->PENSION_STATUS;
		   ...
		   foreach ($all_data_PNPSEF as $pnpsef_data)
		    {
				...
				$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
		   		...
		   		$pension_pnpsef[''] = empty($pnpsef_data->PENSION_STATUS) ? '':$pnpsef_data->PENSION_STATUS;
		   		$pension_pnpsef['Death of retirement'] = empty($pnpsef_data->DATE_RETIREMENT) ? '':$pnpsef_data->DATE_RETIREMENT;
		   		//$pension_pnpsef['Mobile No'] = empty($pension_contact_data->MOBILENO) ? '':$pension_contact_data->MOBILENO;
   ...
   <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
									...
									<select name = "division" class="form-control" id = "divvision">
									   ...
									   <option value="All">All</option>
										<?php
											...
											/*	foreach ($all_division as $division)
						                      {   
						                         echo '<option value="'.$division->DIVISIONNAME.'">'.$division->DIVISIONNAME.'</option>';
						                      }*/
											}
								...
								<?php echo form_close();?>
								<!-- <a href="<?php //echo base_url();?>Reports/Excel" class="btn btn-success" style="float:right;margin-bottom:20px;">  Download Report <i class="fa fa-arrow-circle-down"></i>
								</a> -->
					...
					<div id ="pp1" style="clear:both;">	
						...
						<div class="col-sm-6" style="margin-bottom:25px;padding-left:0;">
							<span><b>Organisation Name:</b></span> <span><?php echo '<b style="color: #f7541d;">'.$organisation_name.'</b>'; ?></span>	
						</div>
					...
					<?php 
							...
							else if($a1>0 || $b1>0 || $c1>0 || $d1>0)
							{
								...
								if($check_certificate_status=='1')
								{
									...
									$pension_certificate_data = $this->Base_model->get_record_by_id('penscertificate', array('ORGANISATION'=> $all_data_POPSEF[0]->ORGANISATION,'STATUS' => 1));
			...
			<table border width="100%">
						...
						<tr>
							<th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="2">S.Nso.</th>
							...
							<!-- <th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="2">Remarks</th> -->
						</tr>
									
						 <tr>
							<!--  <th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="1">Mobile No</th> -->
		   ...
		   <div class="pension-table">
			...
			<table border width="100%">
						...
						<tr>
							...
							<!-- <th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="2"></th> -->
							<th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="2">Date of Retirement</th>
							<th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" colspan="2"></th>
							<th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" rowspan="2">Name of the division dealing the pension cases</th>
							<th style="padding: 10px;text-align: center;font-size: 13px;background: #2662df;color: #fff;" colspan="8"></th>
		  ...
		  <?php } else { ?>
						...
						$a = empty($POPSEF) ? '' : $POPSEF;
						$b = empty($POPSOF) ? '' : $POPSOF;
						$c = empty($PNPSEF) ? '' : $PNPSEF;
						$d = empty($PNPSOF) ? '' : $PNPSOF;
   ...
   foreach ($all_data_POPSEF as $popsef_data)
    {
		...
		$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
   		...
   		$pension_popsef['adahar'] = empty($pension_contact_data->AADHAR_NO) ? '':$pension_contact_data->AADHAR_NO;
   		$pension_popsef['pan'] = empty($pension_contact_data->PAN_NO) ? '':$pension_contact_data->PAN_NO;
		   ...
		   foreach ($all_data_POPSOF as $popsof_data)
		    {
				...
				$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
		   		...
		   		$pension_popsof['adahar'] = empty($pension_contact_data->AADHAR_NO) ? '':$pension_contact_data->AADHAR_NO;
   				$pension_popsof['pan'] = empty($pension_contact_data->PAN_NO) ? '':$pension_contact_data->PAN_NO;
		   ...
		   foreach ($all_data_PNPSEF as $pnpsef_data)
		    {
				...
				else
				{
		   		...
		   		$pension_pnpsef['adahar'] = empty($pension_contact_data->AADHAR_NO) ? '':$pension_contact_data->AADHAR_NO;
   				$pension_pnpsef['pan'] = empty($pension_contact_data->PAN_NO) ? '':$pension_contact_data->PAN_NO;
		   ...
		   foreach ($all_data_PNPSOF as $pnpsof_data)
		    {
				...
				$email_data = $pension_contact_data->MOBILENO.','.$pension_contact_data->EMAILID.','.$pension_contact_data->PANText.','.$pension_contact_data->Adhartext;
		   		...
		   		$pension_pnpsof['adahar'] = empty($pension_contact_data->AADHAR_NO) ? '':$pension_contact_data->AADHAR_NO;
   				$pension_pnpsof['pan'] = empty($pension_contact_data->PAN_NO) ? '':$pension_contact_data->PAN_NO;
   	...
   	/******************************************Ends Pension PNPSOF Code******************************************/
		...
		<style>
		    ...
		    .pension-table{overflow-x:scroll;margin-bottom:50px;clear:both;position:relative;border:1px solid #ddd;}
		   ...
		   if(ccertificate == '1')
			...
			else
			{
				...
				/**********data1***********/
			  	if(data1.length==0)
			  	{
			  		var data1 = [{'Pension Id':'','PPO No':'','Name of the Employee/Pensione':'','':'','Retirement date':'','Mobile No,Email,Pan,Adhar':'','Address':'','Division Name':'','Pension Paper Submission':'','Annual verification of service book completed':'','Case pending with PAO':'','Status of pension papers':'','Terminal Benefits Granted':'','Remarks':'','PAO Remarks if any':''}];
			  	}
			  	...
			  	if(data2.length==0)
			  	{
			  		var data2 = [{'Pension Id':'','PPO No':'','Name of the Employee/Pensione':'','':'','Date of death':'','Mobile No,Email,Pan,Adhar':'','Address':'','Division Name':'','Pension Paper Submission':'','Case pending with PAO':'','Status of pension papers':'','Terminal Benefits Granted':'','Remarks':'','PAO Remarks if any':''}];
			  	}
			  	...
			  	if(data3.length==0)
			  	{
			  		var data3 = [{'Pension Id':'','PPO No':'','Name of the Employee/Pensione':'','':'','Date of retirement':'','Mobile No,Email,Pan,Adhar':'','Address':'','Division Name':'','Pension Paper Submission':'','Withdrawl request submit to NSDL':'','Case pending with PAO':'','Terminal Benefits Granted':'','Terminal Benefits Not Granted':'','Remarks':'','PAO Remarks if any':''}];
			  	}
			  	...
			  	if(data4.length==0)
			  	{
			  		var data4 = [{'Pension Id':'','PPO No':'','Name of the Employee/Pensione':'','':'','Death of death':'','Mobile No,Email,Pan,Adhar':'','Address':'','Division Name':'','Pension Paper Submission':'','Withdrawl request submit to NSDL':'','Case pending with PAO':'','Terminal Benefits Granted':'','Terminal Benefits Not Granted':'','Remarks':'','PAO Remarks if any':''}];
			  	}
					  	 ...
					  	 /*********table1***********/
					  	  ...
					  	  { 
					  	  	 var table1=[];
						  	 	 ...
						  	 	 /*******adhar value******/
						  	 	 var adhar_value = popsef_Array[j].adahar;
									 var Normaltext1 = CryptoJS.AES.decrypt(adhar_value, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var adhar_text_value = Normaltext1.toString(CryptoJS.enc.Utf8); 
									 
									 /******pan value******/

									 var pan_value = popsef_Array[j].pan;
									 var Normaltext2 = CryptoJS.AES.decrypt(pan_value, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var pan_text_value = Normaltext2.toString(CryptoJS.enc.Utf8); 
								 	 ...
								 	 table1[4]=popsef_Array[j].Email + "," + adhar_text_value + "," + pan_text_value;
						  ...
						  var table2_data=[];
					  	  for (var j=0 ; j < popsof_Array.length; j++)
					  	  {
					  	  	 var table2=[];
						  	 	...
						  	 	/*******adhar value******/
						  	 	 var adhar_value2 = popsof_Array[j].adahar;
									 var Normaltext1 = CryptoJS.AES.decrypt(adhar_value2, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var adhar_text_value = Normaltext1.toString(CryptoJS.enc.Utf8); 
									 
									 /******pan value******/

									 var pan_value2 = popsof_Array[j].pan;
									 var Normaltext2 = CryptoJS.AES.decrypt(pan_value2, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var pan_text_value = Normaltext2.toString(CryptoJS.enc.Utf8); 
								...
								// table2[0]='';
								 ...
								 table2[5]=popsof_Array[j].Email + "," + adhar_text_value + "," + pan_text_value;
						  ...
						  var table3_data=[];
					  	  for (var j=0 ; j < pnpsef_Array.length; j++)
					  	  {
					  	  	 var table3=[];
						  	 	 ...
						  	 	 /*******adhar value******/
						  	 	 var adhar_value3 = popsof_Array[j].adahar;
									 var Normaltext1 = CryptoJS.AES.decrypt(adhar_value3, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var adhar_text_value = Normaltext1.toString(CryptoJS.enc.Utf8); 
									 
									 /******pan value******/

									 var pan_value3 = popsof_Array[j].pan;
									 var Normaltext2 = CryptoJS.AES.decrypt(pan_value3, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var pan_text_value = Normaltext2.toString(CryptoJS.enc.Utf8); 
								 ...
								 table3[4]=pnpsef_Array[j].Email + "," + adhar_text_value + "," + pan_text_value;
						  ...
						  var table4_data=[];
					  	  for (var j=0 ; j < pnpsof_Array.length; j++)
					  	  {
					  	  	 var table4=[];
						  	 	 ...
						  	 	 /*******adhar value******/
						  	 	 var adhar_value4 = popsof_Array[j].adahar;
									 var Normaltext1 = CryptoJS.AES.decrypt(adhar_value4, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var adhar_text_value = Normaltext1.toString(CryptoJS.enc.Utf8); 
									 
									 /******pan value******/

									 var pan_value4 = popsof_Array[j].pan;
									 var Normaltext2 = CryptoJS.AES.decrypt(pan_value4, 'asdbasg67532rbdwsfbshdfghsdfwegh');
									 var pan_text_value = Normaltext2.toString(CryptoJS.enc.Utf8);
								...
								// table4[0]='';
								 ...
								 table4[4]=pnpsof_Array[j].Email + "," + adhar_text_value + "," + pan_text_value;
