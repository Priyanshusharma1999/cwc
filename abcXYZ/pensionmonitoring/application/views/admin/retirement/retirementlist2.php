  ...
  /******************************************Pension POPSEF Code***************************************/
   ...
   $get_poposef = array();
   $i=1;
   foreach ($all_retirement_list as $j3) 
   {
						
   foreach ($j3['retirement_list'] as $retire)
    {
   ...
   <div class="page-wrapper">
            <div class="content container-fluid">
                <div class="row">
					...
					<div id = "pp2">
					<?php 
					foreach ($all_retirement_list as $j1) 
					{
			...
			<div class="pension-table">
						...
						<tr>
						 ...
						 <?php
                            if($j1['retirement_list']) {
                           	$i=1;
                            foreach($j1['retirement_list'] as $retirement) { ?>
