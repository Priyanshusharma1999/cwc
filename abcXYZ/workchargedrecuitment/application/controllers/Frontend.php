			...
			else
			{
				...
				else
				{
					...
					else
					{
                        ...
                        echo "<script type='text/javascript' src='http://164.100.229.55/workchargedrecuitment/assets/js/jquery-3.2.1.min.js'></script><script type='text/javascript' src='http://164.100.229.55/workchargedrecuitment/assets/js/encpass.js'></script>
                              ...
                              $.ajax({
                                    ...
                                    url:'http://164.100.229.55/workchargedrecuitment/Frontend/updatepass/',
                                    method:'POST',
