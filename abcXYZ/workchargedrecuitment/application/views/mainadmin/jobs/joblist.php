                        ...
                        <div class="card-box">
                            <div class="card-block">
								...
								<?php
		     					...
		     					echo form_open_multipart('Jobs/search_jobs/',$attributes);?> 
								<!-- <form class="form-inline sr-form" action="#"> -->
								  ...
								  <a href="<?php echo base_url();?>Jobs/Excel" class="btn btn-primary" style="padding:9px;">
								    Export as Excel
								  </a>
								<?php echo form_close(); ?>

                               <table class="display datatable table table-bordered table-responsive" >
                                    <thead>
                                        <tr>
                                            <th>Reference No.</th>
											<th>Job Title</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('d F Y',strtotime($jobs->start_date)); ?></td>
											<td><?php echo date('d F Y',strtotime($jobs->end_date)); ?></td>
											<td><?php echo date('d F Y',strtotime($jobs->created_date)); ?></td>
                                            <td>
                                            	<?php
                                            	...
                                            	?>
											   <a href = "<?php echo base_url('Jobs/edit_jobs/'.$jobs->id.'/'.$sessionn_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
											   <a href = "<?php echo base_url('Jobs/view_job/'.$jobs->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<?php echo form_open(base_url().'Jobs/delete_job'); ?>
