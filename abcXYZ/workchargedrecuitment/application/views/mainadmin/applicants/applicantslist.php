                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                ...
                                <!-- <form class="form-inline sr-form" action="#"> -->
                                  ...
                                  <div class="form-group">
                                    <input name = "applicant_name" type="text"  class="form-control restrict_special_char" placeholder="Applicant Name" >
                                  </div>
                                  <div class="form-group">
                            ...
                            <a href="<?php echo base_url();?>Applicant_admin/Excel" class="btn btn-primary" style="padding:9px;">
                                     Export as Excel
                            </a> 
                                ...
                                <table class="display datatable table table-stripped table-bordered table-responsive" >
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo date('d F Y',strtotime($applicant_data->created_date)); ?>
                                            </td>
                                            <?php $pdf_name =  $applicant_data->pdf_name;
                                            
                                                    $url =base_url().'uploads/applicant_pdf/'.$pdf_name.'.pdf'; ?>
                                            <td>
                                                <?php

                                                    $sess_id = $this->session->userdata('auser_id');
                                                ?>
                                                <a href = "<?php echo base_url('Applicant_admin/edit_job/'.$applicant_data->id.'/'.$sess_id) ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i>Edit</a>
