                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Edit Job Detail</h6>
								<hr>
								<?php
								$sess_id = $this->session->userdata('auser_id');
							 	$attributes = array('class' => '', 'id' =>'add_jobbss');
		     					echo form_open_multipart('Applicant_admin/edit_job/'.$all_job_data[0]->id.'/'.$sess_id,$attributes);?>

								<div class="col-sm-6">
								<div class="form-group">
									<label>Job Status</label>
									<select required="required" name = "job_status" class="form-control">
									   <option selected="selected" value="1" <?php if($all_job_data[0]->job_status == '1') echo 'selected="selected"' ?>>Pending</option>
									   <option  value= "2" <?php if($all_job_data[0]->job_status == '2') echo 'selected="selected"' ?>>Accept</option>

									   <option  value= "3" <?php if($all_job_data[0]->job_status == '3') echo 'selected="selected"' ?>>Reject</option>
									</select>
								</div>
                            </div>
									...
									<div class="panel-body">
									   ...
									   <div class="col-sm-6" style="clear:both;">
											<div class="form-group">
												...
												<textarea class="form-control"  id="preview_present_address" readonly ><?php echo $all_job_data[0]->present_address; ?></textarea>
											</div>
									   ...
									   <div class="col-sm-6">
											<div class="form-group">
												...
												<textarea class="form-control" id ="preview_permanent_address"readonly ><?php echo $all_job_data[0]->permanent_address; ?></textarea>
											</div>
								...
								<!--documents-->
                                      ...
                                      <div class="col-sm-6">									  
										 <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-6">
										    ...
										    <div class="col-sm-6">
										    	<a href = "<?php echo base_url();?>uploads/dob_certificate/<?php echo $file_dob_certificate; ?>" target="_blank">View</a>
									...
									<div class="col-sm-6">		
										 <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-6">
										    ...
										    <div class="col-sm-6">
										    	<a href = "<?php echo base_url();?>uploads/matriculation_certificate/<?php echo $file_matriculation_marksheet; ?>" target="_blank">View</a>
								    ...
								    <div class="col-sm-6">				
										 <div class="form-group" style="width:100%;float:left;">
									       <div class="col-sm-6">
										    ...
										    <div class="col-sm-6">
										    	<a href = "<?php echo base_url();?>uploads/scc_St_obc_certificate/<?php echo $file_sc_st_obc_certitificate; ?>" target="_blank">View</a>
								    ...
								    <div class="col-sm-6" style="clear:both;">
											<div class="form-group">
												...
												<textarea class="form-control" id="preview_present_address" readonly ><?php echo $all_job_data[0]->working_experience; ?></textarea>
									</div>
