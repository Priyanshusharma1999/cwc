                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						$session_id = $this->session->userdata('auser_id');
     					...
     					echo form_open_multipart('Superadmin/add_circle/'.$session_id,$attributes);?>
                    ...
                    ?>
						 ...
						 <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control restrict_special_char" type="text" placeholder="Circle " name="circle_name" maxlength="50"
                        ...
                        <div class="card-box">
                            <div class="card-block">
								...
								<!-- <form class="form-inline sr-form" action="#"> -->
										  <div class="form-group">
											<input type="text" name ="regionn_nname" id="restrict_special_char" class="form-control" placeholder="Region " >
										  </div>
										  <div class="form-group">
											<input type="text" name ="circlee_nname" id="restrict_special_char2" class="form-control" placeholder="Circle " >
										  </div>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
									...
									<?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo date('d F Y', strtotime($circle->created_date)); ?></td>
                                            <td>
                                            	<?php $session_id = $this->session->userdata('auser_id'); ?>
										   <a href = "<?php echo base_url('Superadmin/edit_circle/'.$circle->id.'/'.$session_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
										   <a href = "<?php echo base_url('Superadmin/view_circle/'.$circle->id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
										   <button data-toggle="modal"  data-target="#deleteModal" onclick="remove_circle(<?php echo $circle->id ;?>)"  class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> 
										   </button>
										</td>
                                        </tr>
                                         <?php } } else { ?>
