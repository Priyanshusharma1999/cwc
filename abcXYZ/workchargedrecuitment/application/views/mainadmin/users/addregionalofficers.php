            ...
            <div class="content container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
						$sessiion_id = $this->session->userdata('auser_id');
					 	$attributes = array('class' => '', 'id' =>'add_usserrs');
     					echo form_open_multipart('Users/add_users/'.$sessiion_id,$attributes);?> 
						  ...
						  <div class="col-sm-6">
						     <div class="form-group">
                                ...
                                <input class="form-control" id="pwd" name = "password" type="password" maxlength = "100" placeholder="Password" value = "<?php echo isset($insertData['password']) ? $insertData['password'] : ''; ?>">
						  ...
						  <div class="col-sm-6">
						     <div class="form-group">
                                ...
                                <input class="form-control" id="pwd2" name = "cnfrm_password" type="password" maxlength = "100" placeholder="Confirm Password" value = "<?php echo isset($insertData['cnfrm_password']) ? $insertData['cnfrm_password'] : ''; ?>">
						  ...
						  <div class="col-sm-6">
							...
							<div class="m-t-20" style="clear:both;padding-left:15px;">
								<button onClick="mySubmit();" name="submit" type="submit" class="btn btn-primary">Add User</button>
