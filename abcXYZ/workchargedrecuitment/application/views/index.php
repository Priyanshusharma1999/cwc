	...
	<div class="wl-home-banner">
	         <img src="<?php echo base_url();?>assets/img/JobBanner2.png" style="width:100%;">
     </div>
								  ...
								  <tr>
								    ...
								    <td><img src="<?php echo base_url();?>assets/img/new_red.gif"> 
								    	<?php 
										    	...
										    	echo $circular['job_title']; 
								    	?>
								    </td>
								    <td>
								    	<a href="<?php echo $circular['circular_pdf']; ?>" download="<?php echo $circular['circular_pdf']; ?>"><?php  echo $circular['circular_title']; ?> </a>
								    	
								    </td>
								    <td>
								    		<?php 
								    	
										    	echo $circular['start_date'];  
								    	?>
								    </td>
								    <td>
								    	<?php 
								    	
										    	echo $circular['end_date']; 
								    	?>
