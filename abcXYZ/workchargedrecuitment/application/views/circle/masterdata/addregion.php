     					...
     					echo form_open_multipart('Superadmin/add_region/',$attributes);?> 
						  ...
						  <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" name="region_name" type="text" placeholder="Region Name" maxlength="50" value = "<?php echo isset($insertData['region_name']) ? $insertData['region_name'] : ''; ?>">
