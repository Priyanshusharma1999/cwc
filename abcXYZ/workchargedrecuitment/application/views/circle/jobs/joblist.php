								...
								<!-- <form class="form-inline sr-form" action="#"> -->
								  <div class="form-group">
									<select name = "region_nnname" class="form-control" id = "">
									   <option selected="selected" value="">Select Preferred Region</option>
                    					...
                    					$division_data = $this->Base_model->get_record_by_id('tbl_region', array('id' =>  $circle_user_data->Division));
					                    
					                     ?>
					                      <option value="<?php echo $circle_user_data->Division; ?>"><?php echo $division_data->region_name?></option>
								  ...
								  <div class="form-group">
									...
									<option selected="selected" value="">Select Circle</option>
					                    ...
					                    <?php
                    					$circle_user_data = $this->Base_model->get_record_by_id('tbl_admin', array('id' =>  $this->session->userdata('auser_id')));
                    					$circle_data = $this->Base_model->get_record_by_id('tbl_circle', array('id' =>  $circle_user_data->Circle));
					                    
					                     ?>
					                   
					                    <option value="<?php echo $circle_user_data->Circle; ?>"><?php echo $circle_data->circle_name?></option>
