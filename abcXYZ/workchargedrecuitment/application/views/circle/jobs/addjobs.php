                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
     					...
     					echo form_open_multipart('Circle_jobs/add_jobs/',$attributes);?>
						   ...
						   <div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<!-- <div class="cal-icon"> -->
									  <input class="form-control " name = "start_date" placeholder="dd/mm/yyyy" type="date" value = "<?php echo isset($insertData['start_date']) ? $insertData['start_date'] : ''; ?>">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<!-- <div class="cal-icon"> -->
									  <input class="form-control " name = "end_date" placeholder="dd/mm/yyyy" type="date" value = "<?php echo isset($insertData['end_date']) ? $insertData['end_date'] : ''; ?>">
