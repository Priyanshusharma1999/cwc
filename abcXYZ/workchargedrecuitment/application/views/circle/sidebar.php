			   ...
			   <ul class="nav navbar-nav navbar-right user-menu">
                <li>
                  <?php 
                            ...
                            ?>
                         <span class="user-img"><img class="img-circle" src="<?php echo $user_pic;?>" width="60" height="60" alt="Circle">
                ...
                <div id="sidebar-menu" class="sidebar-menu">
					<ul>
					  ...
					  <li class="<?php if(($this->uri->segment(2))==''){ echo 'active'; } ?>">
                          ...
                          <a href="<?php echo base_url('Circle/index/'.$session_id);?>"><i class="fa fa-dashboard"></i>Dashboard</a>
                       </li> 
