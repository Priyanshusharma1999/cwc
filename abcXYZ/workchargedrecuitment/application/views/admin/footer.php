  ...
  function get_pdf()
          {
            ...
            var applicant_user_idd = "<?php echo $this->session->userdata('applicant_user_id'); ?>";
             var base_url = "<?php echo base_url(); ?>";
                var link = base_url+'Applicant/all_applicant_basic_info_data/';
               // alert(link);
               $.ajax({
                  method: "POST",

                  url: link,
                  data: {'applicant_user_id':applicant_user_idd},
                  success: function(result) {
                    console.log(result); 
    
                    var obj = JSON.parse(result);
                    var ppdf_name = obj.pdf_name;
                    var url = base_url+'uploads/applicant_pdf/'+ppdf_name+'.pdf'; 
