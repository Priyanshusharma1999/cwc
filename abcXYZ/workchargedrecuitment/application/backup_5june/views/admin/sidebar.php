			   ...
			   <ul class="nav navbar-nav navbar-right user-menu">
                <li>
                    <?php 
                        ...
                        <span class="user-img"><img class="img-circle" src="<?php echo $user_pic;?>" width="70" height="70" alt="User">
						...
						<span class="links">
                            ...
                            <a href="<?php echo site_url();?>Applicant/profile"><i class="fa fa-user"></i></a>
                            <a href="<?php echo site_url();?>Applicant/edit_profile"><i class="fa fa-pencil"></i></a>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
					<ul>
                        ...
                        <li class="<?php if(($this->uri->segment(2))==''){ echo 'active'; } ?>">
                            <a href="<?php echo site_url();?>Applicant/"><i class="fa fa-address-card"></i>Apply For Job</a>
                        </li> 
						
						<li class="<?php if(($this->uri->segment(2))=='joblist'){ echo 'active'; } ?>">
                            <a href="<?php echo site_url();?>Applicant/job_list"><i class="fa fa-align-justify"></i>Applied Job List</a>
                        </li> 
