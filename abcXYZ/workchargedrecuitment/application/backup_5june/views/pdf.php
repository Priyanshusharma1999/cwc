...
padding: 5px 15px;font-size: 18px;">Applying Post Details </h3>

<table class="table">
<tr>
    <td><label style="font-size:13px;">Prefered Region:</label></td>
    <td>
...
<h3 style="text-align: left;margin-bottom: 20px;margin-top:0px;background: #0f4c9f;color: #0f4c9f;
padding: 5px 15px;font-size: 18px;">Personal Information Details</h3>
...
<tr>
    <td><label style="font-size:13px;">Fathers Name:</label></td>
    <td>
...
<h3 style="text-align: left;margin-bottom: 20px;margin-top:0px;background: #0f4c9f;color: #0f4c9f;
padding: 5px 15px;font-size: 18px;">Qualifying Exam Details</h3>
...
<tr>
    ...
    <td>
      <span style="width:200px;border:2px solid #0f4c9f;padding:5px 12px;font-size:11px;font-weight:600;display:inline-block">'.$all_job_data[0]->aadhar_no.'</span>
    </td>
</tr>
...
<table class="table">
<tr>
   <td><a style= "font-size: 14px;"  href = "http://192.168.1.112/centralgov/uploads/dob_certificate/'.$dobbb.'" target="_blank">Date Of Birth Certificate</a></td>
   <td><a style= "font-size: 14px;" href = "http://192.168.1.112/centralgov/uploads/matriculation_certificate/'.$matriculation.'" target="_blank">Matriculation Certificate</a></td>
   <td><a style= "font-size: 14px;"  href = "http://192.168.1.112/centralgov/uploads/scc_St_obc_certificate/'.$scst.'" target="_blank">SC/ST Certificate</a></td>
...
<h3 style="text-align: left;margin-bottom: 20px;margin-top:0px;background: #0f4c9f;color: #0f4c9f;
padding: 5px 15px;font-size: 18px;">Disclmair</h3>
...
<tr>
    <td><label style="font-size:13px;"> "I solemnly declare and affirm that the information given above is true & correct to the best of my knowledge and if any incorrect/false information is found, my candidature may be cancelled at any stage and in the event of any mis-statement/ discrepancy in the particulars detected after my appointment, my service is liable to be terminated without any notice to me."</label></td>
                            ...
                            $pdf->WriteHTML($html);
                              ...
                              $pdf->Output('D:/xampp/htdocs/cwc-jobs/uploads/applicant_pdf/'.$pdf_name.'.pdf','F');
