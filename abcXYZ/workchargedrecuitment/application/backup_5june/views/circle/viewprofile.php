                                            ...
                                            <div class="form-group form-focus">
                                              <!--   <label class="control-label">Birth Date</label> -->
                                                <!-- <div class="cal-icon"> -->
                                                    ...
                                                    <input type="text" value = "<?php echo $region_data->region_name; ?>" class="form-control floating" placeholder = "User Id" readonly>
                                               <!--  </div> -->
                                            </div>
                                        </div>
                                         ...
                                         <div class="col-md-5">
                                            ...
                                            <div class="form-group form-focus">
                                              <!--   <label class="control-label">Birth Date</label> -->
                                                <!-- <div class="cal-icon"> -->
                                                    <!-- <input class="form-control floating datetimepicker" type="text"> -->
                                                    <input type="text" value = "<?php echo $circle_data->circle_name; ?>" class="form-control floating" placeholder = "User Id" readonly>
                                               <!--  </div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group form-focus">
                                     <input type="text" value = "<?php if($user_data->user_type==3) echo 'Circle Officer'; else echo ''; ?>" class="form-control floating" placeholder = "User Type" readonly>
                                </div>
                            </div>
