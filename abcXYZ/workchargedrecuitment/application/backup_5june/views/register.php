					 ...
					 <?php
     					...
     					echo form_open_multipart('Frontend/register/',$attributes);?> 
                            ...
                            <div class="form-group form-focus">
                                ...
                                <input class="form-control floating" type="text" name = "applicant_name" placeholder="Enter Name" value = "<?php echo isset($insertData['applicant_name']) ? $insertData['applicant_name'] : ''; ?>" required="required" >
                            ...
                            <div class="form-group form-focus">
                                ...
                                <input class="form-control floating" id = "emaail_verrify_value" name = "email" type="email" placeholder="Enter Email Id" required="required" value = "<?php echo isset($insertData['email']) ? $insertData['email'] : ''; ?>" required="required" >
                                <span class = "text-danger"><?php echo form_error('email');?></span>
								<!-- <button type="button"  id= "emaail_verrify_btn" class="btn btn-sm btn-color">Verify</button> -->
								<span class="errror"></span>
								<!-- <span style="margin-top:5px;display:block;">OTP will be sent to this email id.</span> -->
                            </div>
							
                            <div class="form-group form-focus">
							    <label class="control-label">Mobile No.<span class="required">*</span></label>
                                <input class="form-control floating" id = "phonnnee_verrify_value" name = "mobile_no" type="text" placeholder="Enter Mobile No." value = "<?php echo isset($insertData['mobile_no']) ? $insertData['mobile_no'] : ''; ?>" required="required" >
							...
							<div class="form-group form-focus">
								...
								<!--  <div class="cal-icon"> -->
									  <input class="form-control " name = "dob" placeholder="dd/mm/yyyy" type="date" value = "<?php echo isset($insertData['dob']) ? $insertData['dob'] : ''; ?>" required="required" >
						...
						<a href="javascript:void(0)" onclick="refreshCaptcha()" style="font-size: 22px;margin-left: 20px;"><i class="fa fa-refresh"></i></a>
                            ...
                            <div class="form-group text-center">
                                ...
                                <button name="submit" class="btn btn-primary btn-block account-btn" type="submit">Register</button>
                            </div>
