     					...
     					echo form_open_multipart('Users/add_users/',$attributes);?> 
						  ...
						  <div class="col-sm-6">
						     <div class="form-group">
                                ...
                                <input class="form-control" name = "cnfrm_password" type="password" maxlength = "80" placeholder="Confirm Password" value = "<?php echo isset($insertData['cnfrm_password']) ? $insertData['cnfrm_password'] : ''; ?>">
                            </div>
						  </div>	
