						...
						if($_FILES['circular_pdf']['name'])
                {
                  ...
                  else
                  {
					...
					/*****check Circular********/
						...
						$checked_job = $this->Base_model->check_existent('tbl_circular', array('refrence_no' => $refrence_no,'circular_title' => $circular_title,'circle_id' => $circle_name));
						...
						if($_FILES['circular_pdff']['name'])
                {
                  ...
                  else
                  {
					...
					/*****check circular********/
						...
						$checked_job = $this->Base_model->check_existent('tbl_circular', array('refrence_no' => $refrence_no,'circular_title' => $circular_title,'circle_id' => $circle_name , 'file' =>$pdf_name ));
					...
					{
							$checked_refrence_no = $this->Base_model->check_existent('tbl_circular', array('refrence_no' => $refrence_no,'circle_id' => $circle_name));
							$checked_circular_title = $this->Base_model->check_existent('tbl_circular', array('circular_title' => $circular_title,'circle_id' => $circle_name));
							$get_circular_data = $this->Base_model->get_record_by_id('tbl_circular', array('id' => $uri));
