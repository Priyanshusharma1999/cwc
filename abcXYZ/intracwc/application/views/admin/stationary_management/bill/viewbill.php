	 ...
	 <div class="page-wrapper">
			<div class="content container-fluid">
              ...
              <?php if($bill_detail->bill_type == 'T&P'){?> 
					...
					<?php if(!empty($bill_detail->bill_no)){?>	 
						...
						<textarea class="form-control" name="remark" placeholder="Address" readonly><?php echo $bill_detail->vendor_address; ?></textarea>
						 ...
						 <div class="col-sm-6">
						   <div class="form-group">
						     ...
						     <a href="<?php echo base_url().'uploads/bill_copy/'. $bill_detail->bill_copy; ?>" download>Download Bill Copy</a>
				...
				<?php } else {?>
						...
						<?php if(!empty($bill_detail->vendor_name)){?>
