	 ...
	 <div class="page-wrapper">
            <div class="content container-fluid">
				...
				$attributes = array('class' => 'form-inline sr-form', 'id' =>'search_request');
     		     echo form_open_multipart('onlinestationary/osradmin/search_request/',$attributes);?>			
						...
						<?php echo form_close();?>	
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
								...
								{?>	
									...
									<a href="<?php echo base_url('onlinestationary/osradmin/issueto/'.$request->req_id) ?>" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> Issue To</a>
