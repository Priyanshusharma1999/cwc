						...
						<?php } ?>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
								...
								<?php 
									...
									<a href="<?php echo base_url('onlinestationary/Recievehandover/viewitems/'.$list->handover_id) ?>" class="btn btn-sm btn-info">View Items</a>

								   <?php if(empty($list->handover_otp)){?> 

									<a href="<?php echo base_url('onlinestationary/Recievehandover/Accepthandover/'.$list->handover_id) ?>" class="btn btn-sm btn-success">Accept Handover</a>
