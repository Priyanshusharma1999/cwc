                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Add Organisation</h6>
								<hr>
						...
						<?php
     					...
     					echo form_open_multipart('Contact/Organisation/add_organisation/',$attributes);?>
						   <div class="col-sm-6">
                            ...
                            <div class="m-t-20" style="padding-left:15px;clear:both;">
                                <button class="btn btn-primary" type="submit" name="submit">Add Organisation</button>
                            </div>
                        <?php echo form_close();?>
