	 ...
	 <div class="page-wrapper">
					  ...
					  <?php  
			           ...
			           ?>	
						...
						$attributes = array('class' => 'form-inline sr-form', 'id' =>'search_complain');
			     		echo form_open_multipart('itcomplaint/complain/searchcomplain/',$attributes);?>  
		...
		<?php echo form_close(); ?>
							...
							<a href="<?php echo site_url();?>itcomplaint/complain/addcomplain" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Complaint</a>
							...
							<tr>
							 ...
							 <?php  if (in_array("1", $user_roles) || in_array("14", $user_roles)) {?>
                                ...
                                <?php if($clist['status']=='Pending'){?>
									 ...
									 <a href="<?php echo base_url('itcomplaint/complain/editcomplain/'.$clist['complaint_id']) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>

									<?php }?>

									<?php if($clist['status']=='Inprogress'){?> 
										
                                              <a href="<?php echo base_url('itcomplaint/complain/givefeedback/'.$clist['complaint_id']) ?>" class="btn btn-sm btn-info">View & Action</a>

									 <?php } ?>

									 <?php if(!empty($clist['remarks'])){?> 
										
                                       <a href="<?php echo base_url('itcomplaint/complain/viewcomplain/'.$clist['complaint_id']) ?>" class="btn btn-sm btn-info">View</a>
