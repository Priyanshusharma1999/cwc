					...
					<?php } ?>	
					 ...
					 <select required="required" class="form-control" style="margin-bottom:40px;" disabled>
                       ...
                       <?php if($bill_detail->bill_type == 'T&P'){?> 
     					...
     					echo form_open_multipart('itonlinestationary/bill/editbill/'.$uri,$attributes); ?>
                         ...
                         <div class="m-t-20" style="margin-bottom:20px;clear:both;">
						  ...
						  <table class="table table-stripped table-bordered">
                           ...
                           <a href="<?php echo base_url(); ?>itonlinestationary/bill/" class="btn btn-danger">Cancel</a>
					   </div>
				       ...
				       <?php
						...
						<div class="col-sm-6">
						   <div class="form-group">
							...
							<input class="form-control" value="<?php echo $bill_detail->grand_total; ?>" placeholder="Enter Total Amount" name="totalamount" type="text">
							 <span class = "text-danger"><?php echo form_error('totalamount');?>
						   </div>
						 </div>
...
/**********************************************************/	
        ...
        $(".add-row").click(function(){
			...
			$(".delete-row").click(function(){
						...
						var rows = $('#editmyTable tr').length;
