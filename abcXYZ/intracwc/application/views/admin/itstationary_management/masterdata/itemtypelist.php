                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php } ?>
							...
							<a href="<?php echo site_url();?>itonlinestationary/Itemtype/additemtype"  class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Itemtype</a>
								...
								<?php 
									if($itemtype) {
                                        ...
                                        <tr>
                                         ...
                                         <td>
									<a href="<?php echo base_url('itonlinestationary/Itemtype/edititemtype/'.$type->itemtype_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<?php echo form_open(base_url().'itonlinestationary/Itemtype/delete_itemtype'); ?>
