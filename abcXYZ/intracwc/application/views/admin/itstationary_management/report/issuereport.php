	 ...
	 <div class="page-wrapper">
            <div class="content container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Issue Report</h6>
								<hr>
				...
				$attributes = array('class' => 'form-inline sr-form', 'id' =>'search_request');
     		     echo form_open_multipart('onlinestationary/report/search_issuereport/',$attributes);?>			
		...
		<script>
			...
			window.saveFile = function saveFile () 
			{
		    	...
		    	var res = alasql('SELECT INTO XLSX("Issuereport.xlsx",?) FROM ?',
		                     [opts,[data1]]);
