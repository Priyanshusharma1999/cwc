                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						$uri = $this->uri->segment('4'); 
     					...
     					echo form_open_multipart('itonlinestationary/item/edititem/'.$uri,$attributes);?>
								...
								<div class="form-group">
								    ...
								    <select  class="form-control" name="itemtype">
									   ...
									   <?php foreach($item_type as $item){?>
									    <option value="<?php echo $item->itemtype_id;?>" <?php if($item->itemtype_id == $item_detail->item_type) { echo 'selected'; } ?>>
						 ...
						 <div class="col-sm-6">
						   ...
						   <div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control" type="text" name="unit" value="<?php echo $item_detail->units; ?>" placeholder="Unit">
						 ...
						 <div class="col-sm-6">
							<div class="form-group">
								...
								<input class="form-control" type="number" min="1" name="minqty" placeholder="Minimum Quantity" value="<?php echo $item_detail->quantity_min; ?>">
						 ...
						 <div class="col-sm-6">
							<div class="form-group">
							    ...
							    <input class="form-control" type="number" min="1" name="stockqty" placeholder="Stock Quantity" value="<?php echo $item_detail->quantity_stock; ?>">
								<span class = "text-danger"><?php echo form_error('stockqty');?></span>
							</div>
                         </div>
