                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
     					...
     					echo form_open_multipart('itonlinestationary/Returnitems/returnitem/',$attributes);?>
						  ...
						  <table id="myTable" class="table table-stripped table-bordered table-responsive" >
                           ...
                           <a href="<?php echo base_url(); ?>itonlinestationary/Returnitems/" class="btn btn-danger">Cancel</a>
