	 ...
	 <div class="page-wrapper">
            <div class="content container-fluid">
				...
				$attributes = array('class' => 'form-inline sr-form', 'id' =>'search_request');
     		     echo form_open_multipart('itonlinestationary/approverequisition/search_request/',$attributes);?>			
					...
					<a href="<?php echo base_url('itonlinestationary/approverequisition/approverequest/'.$request->req_id) ?>" class="btn btn-sm btn-primary">Action for Approve</a>
					<?php } ?>	
					
              <a href="<?php echo base_url('itonlinestationary/approverequisition/viewrequest/'.$request->req_id) ?>" class="btn btn-sm btn-success">View</a>
