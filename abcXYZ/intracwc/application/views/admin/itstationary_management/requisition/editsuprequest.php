                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Supplementary Requisition Form</h6>
								<hr>
					...
					<?php 
						$uri = $this->uri->segment('4'); 
     					...
     					echo form_open_multipart('itonlinestationary/Requisition/editsuprequest/'.$uri,$attributes);?>

     					<div class="col-sm-2" style="padding-left:0;">
							<div class="form-group">
								<label>Dir.</label>
								<input class="form-control"  type="number" name="dir" min="0" placeholder="Dir." value="<?php echo $req_detail->dir_no; ?>">
							</div>
                        </div>
                        ...
                        <div class="col-sm-2">
							<div class="form-group">
								<label>Dy. Dir.</label>
								<input class="form-control"  type="number" name="dydir" min="0" placeholder="Dy. Dir." value="<?php echo $req_detail->dydir_no; ?>">
							</div>
                        </div>
                        ...
                        <div class="col-sm-2">
							<div class="form-group">
								<label>A.D./EAD</label>
								<input class="form-control"  type="number" name="ad" min="0" placeholder="A.D./EAD" value="<?php echo $req_detail->adead_no; ?>">
							</div>
                        </div>
                        ...
                        <div class="col-sm-2">
							<div class="form-group">
								...
								<input class="form-control"  type="number" name="dman" min="0" placeholder="Dman/JE Comp" value="<?php echo $req_detail->dman_no; ?>">
							</div>
                        </div>
                         ...
                         <div class="col-sm-2">
							<div class="form-group">
								<label>S.O.</label>
								<input class="form-control"  type="number" name="so" min="0" placeholder="S.O." value="<?php echo $req_detail->so_no; ?>">
							</div>
                        </div>
                         ...
                         <div class="col-sm-2" style="padding-right:0;">
							<div class="form-group">
								<label>Asstt.</label>
								<input class="form-control"  type="number" name="asstt" min="0" placeholder="Asstt." value="<?php echo $req_detail->asstt_no; ?>">
							</div>
                        </div>
                        ...
                        <div class="col-sm-2" style="padding-left:0;">
							<div class="form-group">
								<label>UDC/LDC</label>
								<input class="form-control"  type="number" name="udcldc" min="0" placeholder="UDC/LDC" value="<?php echo $req_detail->udcldc_no; ?>">
							</div>
                        </div>
                         ...
                         <div class="col-sm-2">
							<div class="form-group">
								...
								<input class="form-control"  type="number" name="pasteno" min="0" placeholder="P.A./Steno." value="<?php echo $req_detail->pa_no; ?>">
							</div>
                        </div>
                         ...
                         <div class="col-sm-2">
							<div class="form-group">
								<label>Others</label>
								<input class="form-control"  type="number" name="others" min="0" placeholder="Others" value="<?php echo $req_detail->others; ?>">
							</div>
                        </div>
