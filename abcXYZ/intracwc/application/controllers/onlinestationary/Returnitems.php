...
class Returnitems extends CI_Controller {
	...
	public function index()
	{
		...
		$data['all_items'] = $this->Base_model->get_all_returnitems('items_return',array('service_type'=>2));

		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary');
		$this->load->view('admin/stationary_management/returnitems/returnitemlist',$data);
			 ...
			 foreach($item as $items){
				  ...
				  array(
					...
					if($insertid)
					{
						...
						redirect('onlinestationary/Returnitems');
					}
					...
					else
					{
							...
							$this->load->view('admin/stationary_management/returnitems/returnitem',$data);
							$this->load->view('admin/footer');
