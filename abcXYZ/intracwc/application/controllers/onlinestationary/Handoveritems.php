...
class Handoveritems extends CI_Controller {
	...
	public function index()
	{
		...
		$data['handover_list'] = $this->Base_model->get_all_record_by_condition('handover',array('service_type'=>'2'));

		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary');
		$this->load->view('admin/stationary_management/handoveritems/handoveritemslist',$data);
			...
			$created_date =  date("Y-m-d H:i:s"); 
			 ...
			 $insert_data = array(
				...
				else
				{
				    ...
				    $this->load->view('admin/header');
					$this->load->view('admin/sidebar-stationary');
					$this->load->view('admin/stationary_management/handoveritems/handoveritem',$data);
					$this->load->view('admin/footer');
	...
	public function Verifyhandover(){
		...
		{	
			...
			else
			{
			    ...
			    $this->load->view('admin/header');
				$this->load->view('admin/sidebar-stationary');
				$this->load->view('admin/stationary_management/handoveritems/verifyhanover');
				$this->load->view('admin/footer');
	...
	public function viewitems()
	{
		...
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary');
		$this->load->view('admin/stationary_management/handoveritems/itemlist',$data);
		$this->load->view('admin/footer');
