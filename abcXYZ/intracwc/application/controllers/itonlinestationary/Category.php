...
class Category extends CI_Controller {
		   ...
		   if (in_array("10", $user_roles))
			  {
			  	...
			  	redirect('itonlinestationary/Requisition',$roledata);

			  } else if(in_array("12", $user_roles)){

                redirect('itonlinestationary/osradmin',$roledata);

			  } else if(in_array("13", $user_roles)){

                redirect('itonlinestationary/approverequisition',$roledata);
	...
	public function index()
	{
		...
		$this->load->view('admin/itstationary_management/masterdata/categorylist',$data);
	...
	public function addcategory(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			if($this->form_validation->run() === false) 
			{
				   $data['insertData'] = array(
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-itstationary');
					$this->load->view('admin/itstationary_management/masterdata/addcategory',$data);
					$this->load->view('admin/footer');
					...
					} else
					 {
					  ...
					  $insert_data = array(
						...
						if($insertid)
						{
							...
							redirect('itonlinestationary/Category');
						}
		...
		else
		{
			...
			$this->load->view('admin/header');
			$this->load->view('admin/sidebar-itstationary');
			$this->load->view('admin/itstationary_management/masterdata/addcategory');
			$this->load->view('admin/footer');
	...
	public function editcategory(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			if($this->form_validation->run() === false) 
			{
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-itstationary');
					$this->load->view('admin/itstationary_management/masterdata/editcategory',$data);
					$this->load->view('admin/footer');
