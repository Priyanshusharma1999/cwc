...
class Itemtype extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/itstationary_management/masterdata/itemtypelist',$data);
	...
	public function additemtype(){
					...
					} else
					 {
					  ...
					  $insert_data = array(
						...
						if($insertid)
						{
							...
							redirect('itonlinestationary/Itemtype');
						}
						...
						else
						{
							...
							$this->load->view('admin/header');
							$this->load->view('admin/sidebar-itstationary');
							$this->load->view('admin/itstationary_management/masterdata/additemtype',$data);
							$this->load->view('admin/footer');
						}
					}
				}
		...
		else
		{
		    ...
		    $this->load->view('admin/header');
			$this->load->view('admin/sidebar-itstationary');
			$this->load->view('admin/itstationary_management/masterdata/additemtype');
			$this->load->view('admin/footer');
	...
	public function edititemtype(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			if($this->form_validation->run() === false) 
			{
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-itstationary');
					$this->load->view('admin/itstationary_management/masterdata/edititemtype',$data);
					$this->load->view('admin/footer');
