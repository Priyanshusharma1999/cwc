...
class Complain extends CI_Controller {
	...
	public function index()
	{
		...
		if (in_array("1", $user_roles) || in_array("14", $user_roles)) {
			...
			$complain_list = $this->Base_model->get_all_record_by_condition('complaint',array('service_type'=>1,'delete_status'=>'1','user_id' =>$this->session->userdata('user_id')));
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			if($this->form_validation->run() === false) 
			{
                ...
                $data['complain_category'] = $this->Base_model->get_all_record_by_condition('category',array('status'=>'1','delete_status'=>'1','service_type'=>1));
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-asset');
					$this->load->view('admin/itcomplain_management/addcomplain',$data);
					$this->load->view('admin/footer');
			...
			} else
				{
				 ...
				 $created_date =  date("Y-m-d H:i:s"); 
					  ...
					  $insert_data = array(
						...
						if($insertid)
						{
							...
							$user_logs_data = array(
											...
											'ACTIVITY' 		=> $this->session->userdata('user_name').' complain posted successfully.',
											'ACTIVITYTIME'  => time(),
					...
					/*********ends logs code*******/
							...
							$data['complain_list'] = $this->Base_model->get_all_record_by_condition('complaint',array('service_type'=>1,'delete_status'=>'1'));
							
							redirect('itcomplaint/complain',$data);
						}
						...
						/*********logs code*******/
							...
							$user_logs_data = array(
											...
											'CLIENT_IP' 	=> $_SERVER['REMOTE_ADDR'],
											'LOGINSTATUS' 	=> 'Logged in',
											'ACTIVITY' 		=> $this->session->userdata('user_name').' failed to post complain.',
											'ACTIVITYTIME'  => time(),
											'CREATEDDATED'  => $created_date
	...
	public function editcomplain(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			$data['room'] = $this->Base_model->get_record_by_id('room_no',array('status'=>'1','delete_status'=>'1','room_id'=>$comp_det->room_id));
				...
				$this->load->view('admin/header');
				$this->load->view('admin/sidebar-asset');
				$this->load->view('admin/itcomplain_management/editcomplain',$data);
				$this->load->view('admin/footer');
					  ...
					  $update_data = array(
						...
						if($updateid)
						{
							...
							$user_logs_data = array(
											...
											'CLIENT_IP' 	=> $_SERVER['REMOTE_ADDR'],
											'LOGINSTATUS' 	=> 'Logged in',
											'ACTIVITY' 		=> $this->session->userdata('user_name').' updated posted complain.',
											'ACTIVITYTIME'  => time(),
											'CREATEDDATED'  => $created_date
						  ...
						  $this->session->set_flashdata('flashError_complain', $msg);
						   ...
						   /*********logs code*******/
							...
							$user_logs_data = array(
											...
											'CLIENT_IP' 	=> $_SERVER['REMOTE_ADDR'],
											'LOGINSTATUS' 	=> 'Logged in',
											'ACTIVITY' 		=> $this->session->userdata('user_name').' fail to update posted complain.',
											'ACTIVITYTIME'  => time(),
											'CREATEDDATED'  => $created_date
	...
	public function givefeedback(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			$data['room'] = $this->Base_model->get_record_by_id('room_no',array('status'=>'1','delete_status'=>'1','room_id'=>$comp_det->room_id));
				...
				$this->load->view('admin/header');
				$this->load->view('admin/sidebar-asset');
				$this->load->view('admin/itcomplain_management/feedback',$data);
				$this->load->view('admin/footer');
					  ...
					  $update_data = array(
						...
						if($insertid)
						{
							...
							$user_logs_data = array(
											...
											'CLIENT_IP' 	=> $_SERVER['REMOTE_ADDR'],
											'LOGINSTATUS' 	=> 'Logged in',
											'ACTIVITY' 		=> $this->session->userdata('user_name').' give feedback.',
											'ACTIVITYTIME'  => time(),
											'CREATEDDATED'  => $created_date
						  ...
						  $this->session->set_flashdata('flashError_complain', $msg);
						   ...
						   /*********logs code*******/
							...
							$user_logs_data = array(
											...
											'CLIENT_IP' 	=> $_SERVER['REMOTE_ADDR'],
											'LOGINSTATUS' 	=> 'Logged in',
											'ACTIVITY' 		=> $this->session->userdata('user_name').' falied to edit complain.',
											'ACTIVITYTIME'  => time(),
											'CREATEDDATED'  => $created_date
	...
	public function viewcomplain(){
			...
			$this->load->view('admin/header');
			$this->load->view('admin/sidebar-asset');
			$this->load->view('admin/itcomplain_management/viewcomplain',$data);
			$this->load->view('admin/footer');
