                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Update Complaint</h6>
								<hr>
                 <?php 
				$uri = $this->uri->segment('4'); 
				$attributes = array('class' => '', 'id' =>'edit_complain');
     			echo form_open_multipart('nonitcomplaint/complain/editcomplain/'.$uri,$attributes); ?>
					    ...
					    <input class="form-control floating" name="empname" type="text"  value="<?php echo $complain_detail->name; ?>" readonly>
							...
							<div class="col-sm-6">
								...
								<input class="form-control floating" type="text" placeholder="Enter Landline No." name="landline_no" value="<?php echo $complain_detail->landline_no; ?>" maxlength="13">
							...
							<div class="col-sm-6">
								...
								<input class="form-control floating" name="intercom" type="text" placeholder="Enter B.P.L. No." value="<?php echo $complain_detail->intercom; ?>"  maxlength="5" >
								</div>
                            </div>
						   ...
						   <div class="col-sm-6">
							   ...
							   <textarea class="form-control" name="description"  placeholder="Description"><?php echo $complain_detail->description; ?></textarea>
