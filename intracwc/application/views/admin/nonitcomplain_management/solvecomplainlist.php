						...
						{   $i=1; 
							...
							<tr>
                                ...
                                <?php if(empty($clist['remarks'])){?>
									 ...
									 <a href="<?php echo base_url('nonitcomplaint/solvecomplain/resolvecomplain/'.$clist['complaint_id']) ?>" class="btn btn-sm btn-info">View & Action</a>

									<?php } ?>

									<?php if($clist['status']=='Fixed'){?>

						  <a href="<?php echo base_url('nonitcomplaint/solvecomplain/viewcomplain/'.$clist['complaint_id']) ?>" class="btn btn-sm btn-info">View</a>
