			...
			<div class="content container-fluid">
				...
				<?php
					$attributes = array('class' => '', 'id' =>'add_complain');
     				echo form_open_multipart('itcomplaint/complain/addcomplain/',$attributes);?>
					    ...
					    <input class="form-control floating" name="empname" type="text"  value="<?php echo $user_detail->user_name; ?>" readonly>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input class="form-control floating" name="intercom" type="text" placeholder="Enter B.P.L. No." maxlength="5" value="<?php echo $intercom; ?>">
								</div>
                            </div>
