 ...
 <div class="page-wrapper">
            ...
            <div class="row">
				...
				<?php } ?>
					...
					<?php
     					...
     					echo form_open_multipart('onlinestationary/item/search_item/',$attributes);?>
							  ...
							  <div class="form-group">
								<select  class="form-control" name="category" id="categy">
						  ...
						  <div class="form-group">
							<select  class="form-control" name="subcategory" id="subcatgy">
						  ...
						  <?php echo form_close();?>
							...
							<a href="<?php echo site_url();?>onlinestationary/item/additem"  class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Item</a>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
								  ...
								  <?php
                                        ...
                                        <tr>
                                         ...
                                         <td>
									<a href="<?php echo base_url('onlinestationary/item/edititem/'.$item->item_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
									 ...
									 <a href="<?php echo base_url('onlinestationary/item/viewitem/'.$item->item_id) ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<?php echo form_open(base_url().'onlinestationary/item/delete_item'); ?>
		...
		<script type="text/javascript">
			function remove_circle(id) 
			{
		  	...
		  	$('#categy').on('change', function(event){

                    var cat_id = $("#categy").val();
                    
                    var option  = '<option selected="selected" value="">Select Subcategory</option>';
