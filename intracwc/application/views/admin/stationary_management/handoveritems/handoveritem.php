					...
					<?php if($this->session->flashdata('flashError_item')) { ?>
                      ...
                      <form action="javascript:void(0);">
					    ...
					    <form action="javascript:void(0);" style="padding-top:40px;clear:both;">
     					...
     					echo form_open_multipart('onlinestationary/Handoveritems/handover/',$attributes);?>
                         ...
                         <a href="<?php echo base_url(); ?>onlinestationary/Handoveritems/" class="btn btn-danger">Cancel</a>
