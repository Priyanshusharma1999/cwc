            ...
            <div class="content container-fluid">
				...
				<?php 
		            ...
		            ?>
						...
						<?php
     					...
     					echo form_open_multipart('onlinestationary/Requisition/search_requisition/',$attributes);?>
						...
						<?php echo form_close();?>
						 ...
						 <?php if (in_array("11", $user_roles)) {?>
						   ...
						   <a href="<?php echo site_url();?>onlinestationary/Requisition/addrequisition" class="btn btn-success pull-right" <?php if(($check_requisition == '1') && ($monyh_req == '1')){ echo 'disabled'; } ?> ><i class="fa fa-plus"></i>Create Requisition</a>

						  <a href="<?php echo site_url();?>onlinestationary/Requisition/addsuprequisition" class="btn btn-success pull-right"  style="margin-right:20px;">Supplementary Requisition</a>	

						   <a href="<?php echo site_url();?>onlinestationary/Requisition/addmiscallenous" class="btn btn-success pull-right" style="margin-right:20px;">Miscallenous Requisition</a>
			     ...
			     <a href="<?php echo base_url('onlinestationary/Requisition/viewrequest/'.$request->req_id) ?>" class="btn btn-sm btn-success">view</a>
			 ...
			 <?php if (in_array("11", $user_roles)) { ?>
				...
				<?php if(($request->status=='Pending') && ($request->is_miscallenous =='0')){?>	
					     ...
					     <a href="<?php echo base_url('onlinestationary/Requisition/editrequest/'.$request->req_id) ?>" class="btn btn-sm btn-info">Edit</a>
						 
					<?php } ?>	 

					<?php if(($request->status=='Pending') && ($request->is_miscallenous=='1')){?>	

					     <a href="<?php echo base_url('onlinestationary/Requisition/editmiscallenous/'.$request->req_id) ?>" class="btn btn-sm btn-info">Edit</a>
