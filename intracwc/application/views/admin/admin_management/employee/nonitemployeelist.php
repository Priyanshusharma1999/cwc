                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
                            <div class="card-block">
                                <h6 class="card-title text-bold">Employee List</h6>
								<hr>
							...
							<?php $user_role_data  = $this->Base_model->get_all_record_by_condition('save_users_role', array('user_id' => $this->session->userdata('user_id'))); 
								...
								<?php
			     					...
			     					echo form_open_multipart('Administrator/Employee/search_employee',$attributes);
			     				?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<?php if (in_array("1", $user_roles)){ ?>
											    ...
											    <button data-toggle="modal"  data-target="#deleteModal" onclick="remove_employee(<?php echo $employee->employee_id ;?>)"  class="btn btn-sm btn-danger"><i class="fa fa-close"></i></button>
