                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						$uri = $this->uri->segment('4'); 
						 ...
						 <div class="col-sm-6">
							<div class="form-group">
								<label>Alert Min Quantity<span class="required">*</span></label>
								<input class="form-control" type="number" min="0" name="minqty" placeholder="Alert Min Quantity" value="<?php echo $item_detail->quantity_min; ?>">
