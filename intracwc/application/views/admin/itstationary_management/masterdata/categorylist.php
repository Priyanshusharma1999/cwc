            ...
            <div class="content container-fluid">
                <div class="row">
					...
					<?php
     					...
     					echo form_open_multipart('itonlinestationary/Category/search_category/',$attributes);?>
						  ...
						  <?php echo form_close();?>
							...
							<a href="<?php echo site_url();?>itonlinestationary/Category/addcategory"  class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Category</a>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
								...
								<?php 
                                        ...
                                        <tr>
                                         ...
                                         <td>
									<a href="<?php echo base_url('itonlinestationary/Category/editcategory/'.$category->category_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<?php echo form_open(base_url().'itonlinestationary/Category/deletecategory'); ?>
