            ...
            <div class="content container-fluid">
                <div class="row">
					...
					<?php
     					...
     					echo form_open_multipart('itonlinestationary/Subcategory/search_subcategory/',$attributes);?>
						  ...
						  <?php echo form_close();?>
							...
							<a href="<?php echo site_url();?>itonlinestationary/Subcategory/addsubcategory"  class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Subcategory</a>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
								...
								<?php 
                                        ...
                                        <tr>
                                         ...
                                         <td>
											<a href="<?php echo base_url('itonlinestationary/Subcategory/editsubcategory/'.$subcategory->subcat_id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i></a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<?php echo form_open(base_url().'itonlinestationary/Subcategory/deletesubcategory'); ?>
