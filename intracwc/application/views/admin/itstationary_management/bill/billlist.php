                ...
                <div class="row">
				   ...
				   <?php if($this->session->flashdata('flashSuccess_bill')) { ?>
					...
					<?php
     					...
     					echo form_open_multipart('itonlinestationary/bill/searchbill/',$attributes);?>
					...
					<?php echo form_close();?>		
							...
							<a href="<?php echo site_url();?>itonlinestationary/bill/addbill" class="btn btn-success pull-right"><i class="fa fa-plus"></i>Add Challan/Bill</a>
                               ...
                               <table class="display datatable table table-stripped table-bordered table-responsive" >
									...
									<?php
                                        ...
                                        <tr>
											...
											<td>
									    <a href="<?php echo base_url('itonlinestationary/bill/editbill/'.$bill->bill_master_id)?>" class="btn btn-sm btn-info">Edit</a>
										<a href="<?php echo base_url('itonlinestationary/bill/viewbill/'.$bill->bill_master_id)?>" class="btn btn-sm btn-primary">Details</a>

										 <button onclick="print_bill(<?php echo $bill->bill_master_id ;?>)"  class="btn btn-sm btn-danger">Print</button>

										  <?php if($bill->bill_type == 'TNP'){?>
   	  	...
   	  	function print_bill(id) 
					{
    					...
    					var link = base_url+'itonlinestationary/bill/getpdfdata';

						 $.ajax({
					        method: "POST",
					        url: link,
					        data: {'bill_master_id':bill_id,'service_type':'1'},
