                   ...
                   <?php if($this->session->flashdata('flashError_request')) { ?>
					...
					<div class="proxydata">
						...
						<form action="javascript:void(0);">
     					...
     					echo form_open_multipart('itonlinestationary/osradmin/addproxy/',$attributes);?>
                          ...
                          <a href="<?php echo base_url(); ?>itonlinestationary/osradmin/proxylist/" class="btn btn-danger">Cancel</a>
...
/**********************************************************/		
		...
		$(".proxydata").show();
         ...
         var link = base_url+'itonlinestationary/osradmin/getuser_detail/';
