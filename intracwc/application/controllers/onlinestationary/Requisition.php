...
class Requisition extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/stationary_management/requisition/requestlist',$data);
			...
			if($this->form_validation->run() === false) 
			{
				...
				$data['section'] = $this->Base_model->get_record_by_id('section',array('section_id'=>$user_detail->section_id));
				   ...
				   $data['insertData'] = array(
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-stationary',$roledata);
					$this->load->view('admin/stationary_management/requisition/addrequest',$data);
					$this->load->view('admin/footer');
				...
				$reqid = $this->Base_model->insert_one_row('osr_requisition_master', $insert_master);	 
				   ...
				   if($reqid){
						...
						if($insertid)
						{
							...
							'notification_message' 	=> 'New Request has placed by '.$user_detail->display_name.' from '.$office->office_name.'',
							'read_status' 	        => '0',
							'issuerread_status'     => '0',
							'delete_status' 	    => '0',
							'service_type' 	        => '2',
				         ...
				         $notifiid = $this->Base_model->insert_one_row('tbl_notification', $insert_notdata);	
							...
							redirect('onlinestationary/Requisition');
						}
  ...
  public function addsuprequisition(){
			...
			if($this->form_validation->run() === false) 
			{
				...
				$data['section'] = $this->Base_model->get_record_by_id('section',array('section_id'=>$user_detail->section_id));
				   ...
				   $data['insertData'] = array(
					...
					$this->load->view('admin/stationary_management/requisition/addsuprequest',$data);
					$this->load->view('admin/footer');
	...
	public function addmiscallenous(){
		...
		if(isset($_REQUEST['submit'])) 
		{
			...
			if($this->form_validation->run() === false) 
			{
				...
				$data['all_items'] = $this->Base_model->get_all_record_by_condition('osr_item_master',array('status'=>1,'delete_status'=>0,'service_type'=>2,'category_id'=>'13','subcategory_id'=>'51'));
				...
				$data['section'] = $this->Base_model->get_record_by_id('section',array('section_id'=>$user_detail->section_id));
				   ...
				   $data['insertData'] = array(
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-stationary',$roledata);
					$this->load->view('admin/stationary_management/requisition/addmiscallenous',$data);
					$this->load->view('admin/footer');
			...
			if($this->form_validation->run() === false) 
			{
			   ...
			   $uri = $this->uri->segment('4'); 
				...
				$data['section'] = $this->Base_model->get_record_by_id('section',array('section_id'=>$user_detail->section_id));
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-stationary',$roledata);
					$this->load->view('admin/stationary_management/requisition/editsuprequest',$data);
					$this->load->view('admin/footer');
			...
			if($this->form_validation->run() === false) 
			{
			   ...
			   $uri = $this->uri->segment('4'); 
				...
				$data['section'] = $this->Base_model->get_record_by_id('section',array('section_id'=>$user_detail->section_id));
					...
					$this->load->view('admin/header');
					$this->load->view('admin/sidebar-stationary',$roledata);
					$this->load->view('admin/stationary_management/requisition/editmiscallenous',$data);
					$this->load->view('admin/footer');
	...
	public function viewrequest()
	{
		...
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary',$roledata);
		$this->load->view('admin/stationary_management/requisition/viewrequest',$data);
		$this->load->view('admin/footer');
