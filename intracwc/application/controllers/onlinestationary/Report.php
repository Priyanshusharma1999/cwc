...
class Report extends CI_Controller {
	...
	public function index()
	{
		...
		$data['all_request'] = $this->Base_model->get_all_record_by_condition('osr_requisition_master',array('delete_status'=>'0','service_type'=>'2','status'=>'Pending'));
		...
		$this->load->view('admin/stationary_management/report/requisitionreport',$data);
	...
	public function miscreport()
	{
		...
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary',$roledata);
		$this->load->view('admin/stationary_management/report/miscreport',$data);
		$this->load->view('admin/footer');
	...
	public function proxylist()
	{
			...
			$this->load->view('admin/header');
			$this->load->view('admin/sidebar-stationary',$roledata);
			$this->load->view('admin/stationary_management/report/proxyreport',$data);
			$this->load->view('admin/footer');
	}//ends function
	...
	{
			$data['all_request'] = $this->Base_model->get_all_record_by_condition('osr_requisition_master',array('delete_status'=>0,'service_type'=>2,'status'=>'Approved'));
		...
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary',$roledata);
		$this->load->view('admin/stationary_management/report/approvereport',$data);
		$this->load->view('admin/footer');
	}
	...
	{
	   $data['all_request'] = $this->Base_model->get_all_record_by_condition('osr_requisition_master',array('delete_status'=>0,'service_type'=>2,'status'=>'Closed'));
		...
		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary',$roledata);
		$this->load->view('admin/stationary_management/report/issuereport',$data);
		$this->load->view('admin/footer');
	}
  ...
  public function directorateitem()
	{
      ...
      $data['all_request'] = $this->Base_model->get_all_record_by_condition('osr_requisition_master',array('delete_status'=>0,'service_type'=>2,'status'=>'Closed'));
		...
		$this->load->view('admin/stationary_management/report/directorateitemreport',$data);
		$this->load->view('admin/footer');
	}
	...
	public function itemhistoryreport()
	{
		...
		$data['all_items'] = $this->Base_model->get_all_itemhistory('historical_item_master',array('status'=>'1','delete_status'=>'0','service_type'=>'2'));

		$this->load->view('admin/header');
		$this->load->view('admin/sidebar-stationary');
		$this->load->view('admin/stationary_management/report/itemhistoryreport',$data);
		$this->load->view('admin/footer');
	}
    ...
    public function search_reqreport(){
     ...
     public function search_directreport(){
    	...
    	if(isset($_REQUEST['submit'])){
			...
			if(!empty($directorate_id)){
				...
				foreach($all_emp as $emp){
					...
					$reqqst = $this->Base_model->get_all_record_by_condition('osr_requisition_master',array('emp_id'=>$emp->employee_id));

					foreach($reqqst as $newdata){

					  $tempdata = $this->Base_model->get_record_by_id('osr_requisition_master',array('req_id'=>$newdata->req_id,'delete_status'=>0,'service_type'=>2,'status'=>'Closed'));
			   ...
			   $data['all_request'] = array_filter($alldata);
			...
			$this->load->view('admin/footer');
             ...
             redirect('onlinestationary/report/directorateitem');
	  ...
	  public function getdirectoratereport(){
	  	  ...
	  	  $item_issuedet = $this->Base_model->get_all_record_by_condition('osr_requisition_item',array('item_id' => $item_id,'approved_qty>'=>'0','service_type'=>'2'));
