...
class Approverequisition extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/itstationary_management/requestapprove/requestlist',$data);
				     ...
				     $appdaily_stck = $approved_stock->approveddaily_stock+$approveqty[$i];
					  ...
					  $i++;
						...
						if($finalid)
						{
							...
							redirect('itonlinestationary/approverequisition',$data);
						}
	 ...
	 public function viewrequest(){
		 ...
		 $user_role_data  = $this->Base_model->get_all_record_by_condition('save_users_role', array('user_id' => $this->session->userdata('user_id')));
		   ...
		   if (in_array("13", $user_roles))
			...
			$this->load->view('admin/header');
			$this->load->view('admin/sidebar-itstationary',$roledata);
			$this->load->view('admin/itstationary_management/requestapprove/viewapproverequest',$data);
			$this->load->view('admin/footer');
