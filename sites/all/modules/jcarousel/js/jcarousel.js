...
return '<a href="javascript:void(0)" class="jcarousel-control jcarousel-control-button-previous">prev</a>'+
 '<a href="javascript:void(0)" class="jcarousel-control jcarousel-control-button-next">next</a>';
};


 
Drupal.theme.prototype.jCarouselPageLink = function(pageNumber) {
  return '<a href="javascript:void(0)">right<span>' + (pageNumber) + '</span></a>';
};
