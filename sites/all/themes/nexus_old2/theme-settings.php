...
function nexus_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['nexus_settings']['sub_logo'] = array(
    '#type' => 'checkbox',
    '#title' => t('do you want to upload sub banner'),
    '#default_value' => theme_get_setting('sub_logo','nexus'),
    '#description'   => t("Check this option to show sub_logo in page. Uncheck to hide."),
  );
...
$form['latest_news'] = array(
    '#type'          => 'textfield',
    '#title'         => t('Latest News'),
    '#default_value' => theme_get_setting('latest_news'),
    '#description'   => t("Place this text in the latest news spot on your site."),
  );
}
